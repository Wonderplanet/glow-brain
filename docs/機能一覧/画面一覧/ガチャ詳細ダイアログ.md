...
|----------------|-------------|----------------|
| OprGacha.GachaId | opr_gachas.id | ガチャID（詳細情報の取得対象） |
| OprGacha.AnnouncementId | opr_gachas.display_information_id | お知らせID（お知らせタブに表示するコンテンツの特定に使用） |
| OprGacha.GachaCautionId | opr_gachas.display_gacha_caution_id | ガチャ注意事項ID（注意事項タブに表示するHTMLファイルの特定に使用） |
