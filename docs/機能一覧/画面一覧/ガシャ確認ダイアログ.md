...
| | PaidDiamond | 有償ダイヤ所持量（プラットフォーム別） |
| **UserItem**<br>ユーザーアイテム | MstItemId | アイテムID |
| | Amount | 所持量（チケット所持数など） |
| **UserGacha**<br>ユーザーガチャ実行履歴 | OprGachaId | ガチャID |
| | DailyPlayCount | 1日あたりの実行回数（広告ガチャ用） |
