...
施策ディレクトリパス（例: `マスタデータ/運営仕様/新春ガチャ`）
...
**要件ファイル構成.md**を読み、含まれるコンテンツタイプを自然言語理解で識別してください。

```
Read(file_path: "<施策ディレクトリ>/要件ファイル構成.md")
```

要件ファイル構成を読んで、以下のコンテンツタイプが含まれているか判断してください：
- **gacha**: ガチャ関連
- **battle**: バトル関連
- **mission**: ミッション関連
- **shop**: ショップ/パック関連
...
ファイル名、内容の記述、文脈から総合的に判断し、識別されたコンテンツタイプをリストアップしてください。
