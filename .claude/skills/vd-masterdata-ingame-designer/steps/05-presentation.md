...
**参照ファイル（必須）**:
- `.claude/skills/vd-masterdata-ingame-designer/references/series-koma-assets.csv` — 作品別アセット情報
- `.claude/skills/vd-masterdata-ingame-designer/references/vd-column-defaults.md` — デフォルト値（loop_background_asset_key等）
...
- `.claude/skills/vd-masterdata-ingame-designer/references/series-koma-assets.csv` — 作品別アセットキー
- `.claude/skills/vd-masterdata-ingame-designer/references/vd-column-defaults.md` — デフォルト値（loop_background_asset_key等）
