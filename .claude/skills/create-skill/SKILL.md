...
参照:
- **[テンプレートガイド](guides/skill-md-template.md)** - SKILL.md全体の構成
- **[frontmatterガイド](guides/frontmatter-guide.md)** - frontmatterの詳細ルール（全10パラメータ）
...
- **[frontmatterガイド](guides/frontmatter-guide.md)** - frontmatterの詳細ルールと制約（全10パラメータ）
