...
```
content_type: gacha
施策ディレクトリ: マスタデータ/施策/20260216_君のことが大大大大大好きな100人の彼女 いいジャン祭
```
...
例（gacha の場合）:
```bash
ls "マスタデータ/施策/20260216_君のことが大大大大大好きな100人の彼女 いいジャン祭/要件/" | grep -E "(06_ガシャ|ガシャ.*設計書|ピックアップガシャ)"
```
