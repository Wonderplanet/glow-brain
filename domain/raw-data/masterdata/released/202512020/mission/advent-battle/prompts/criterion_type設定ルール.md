...
criterion_typeには、このドキュメントに記載されている値のみ設定できます。
...
各criterion_typeの詳細説明を参考に、適切な値を設定してください。
...
以下は、設定可能なすべてのcriterion_typeのリストです。
...
**原因**: 定義されていないcriterion_typeを設定している

**対処**:
1. このドキュメントの「全criterion_typeリスト」セクションを確認
