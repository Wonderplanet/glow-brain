...
| 資料 | 説明 | 場所 |
|------|------|------|
| **ミッショントリガー一覧** | criterion_typeの定義一覧 | NotebookLM登録済み |
...
イベントミッション（mst_event_id指定）で使用可能なcriterion_typeは、NotebookLMに登録されている「ミッショントリガー一覧 - データ入力用ミッショントリガー一覧」に記載されています。
...
```csv
ENABLE,id,release_key,group_id,mst_mission_event_id,unlock_order,備考
e,1,202512020,event_osh_00001_1,event_osh_00001_1,1,
e,2,202512020,event_osh_00001_1,event_osh_00001_2,2,
e,3,202512020,event_osh_00001_1,event_osh_00001_3,3,
e,4,202512020,event_osh_00001_1,event_osh_00001_4,4,
e,5,202512020,event_osh_00001_28,event_osh_00001_28,1,
e,6,202512020,event_osh_00001_28,event_osh_00001_29,2,
e,7,202512020,event_osh_00001_28,event_osh_00001_30,3,
```
...
|---------|-----------|
| **ENABLE** | 固定値: `e` (有効化) |
| **id** | 報酬レコードの一意識別子。命名規則: `mission_reward_{連番}` |
| **release_key** | リリースキー。MstMissionEventと同じ値 |
...
e,mission_reward_2,202512020,osh_00001_event_reward_5,FreeDiamond,,50,1,
e,mission_reward_3,202512020,osh_00001_event_reward_33,Coin,,1000,1,
e,mission_reward_4,202512020,osh_00001_event_reward_41,Emblem,emblem_event_osh_00008,1,1,
```
...
- [ ] **ID採番ルール**
  ...
  - MstMissionEventI18n.id: `{mst_mission_event_id}_{language}`
    - 例: `event_osh_00001_1_ja`, `event_kai_00001_28_ja`
  - MstMissionEventDependency.id: 連番（1, 2, 3...）
  ...
  - MstMissionReward.id: `mission_reward_{連番}`
    - 例: `mission_reward_1`, `mission_reward_2`
