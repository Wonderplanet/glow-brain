...
| ファイル | 説明 | パス例 |
|---------|------|--------|
| **ミッション** | イベントミッションの達成条件・報酬内容 | `domain/raw-data/google-drive/spread-sheet/GLOW/080_運営/いいジャン祭（施策）/運営_仕様書/<施策名>/04_ミッション.csv` |
| **施策概要・リソース情報** | 新規リソースID情報 | `domain/raw-data/google-drive/spread-sheet/GLOW/080_運営/いいジャン祭（施策）/運営_仕様書/<施策名>/04_ミッション.csv` |
