# osh Normalブロック インゲームマスタデータ生成プロンプト
...
```
/vd-ingame-creator 作品ID osh の Normalブロック を作る。
...
作品ID=osh AND データタイプ=ノーマルブロック登場
...
| 敵キャラID | 敵キャラ名 |
|------------|------------|
| chara_osh_00201 | 星野 ルビー |
| chara_osh_00301 | MEMちょ |
| chara_osh_00401 | 有馬 かな |
| chara_osh_00501 | 黒川あかね |
