# gom Normalブロック インゲームマスタデータ生成プロンプト
...
```
/vd-ingame-creator 作品ID gom の Normalブロック を作る。
...
作品ID=gom AND データタイプ=ノーマルブロック登場
...
| 敵キャラID | 敵キャラ名 |
|------------|------------|
| enemy_gom_00402 | たこ焼き |
| enemy_gom_00501 | バタートースト |
| enemy_gom_00701 | ラーメン |
