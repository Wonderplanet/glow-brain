...
|----|------------------------|---------------------|-----------|-------|-----|--------------|------------|---------------------|
| e_chi_00001_general_Boss_Yellow | enemy_chi_00001 | Boss | Attack | Yellow | 300,000 | 600 | 40 | 1 |
| e_chi_00101_general_Normal_Colorless | enemy_chi_00101 | Normal | Defense | Colorless | 5,000 | 320 | 35 | 1 |
| e_chi_00101_general_Normal_Yellow | enemy_chi_00101 | Normal | Technical | Yellow | 13,000 | 720 | 35 | 1 |
| e_chi_00201_general_Normal_Yellow | enemy_chi_00201 | Normal | Attack | Yellow | 200,000 | 320 | 50 | 1 |
| e_chi_00201_general_Boss_Yellow | enemy_chi_00201 | Boss | Attack | Yellow | 500,000 | 320 | 50 | 7 |

### キャラエネミー（normal/hard で使用）

| id | mst_enemy_character_id | character_unit_kind | role_type | color | hp | attack_power | move_speed | attack_combo_cycle |
|----|------------------------|---------------------|-----------|-------|-----|--------------|------------|---------------------|
| c_chi_00201_general_Normal_Colorless | chara_chi_00201 | Normal | Attack | Yellow | 100,000 | 240 | 45 | 7 |
| c_chi_00201_general_Normal_Yellow | chara_chi_00201 | Normal | Attack | Yellow | 100,000 | 240 | 45 | 7 |
| c_chi_00201_general_Boss_Yellow | chara_chi_00201 | Boss | Attack | Yellow | 500,000 | 400 | 45 | 7 |
| c_chi_00301_general_Normal_Yellow | chara_chi_00301 | Normal | Attack | Yellow | 250,000 | 400 | 45 | 7 |
| c_chi_00002_general_Boss_Yellow | chara_chi_00002 | Boss | Technical | Yellow | 400,000 | 450 | 50 | 5 |
...
- **bossブロック用**: `chara_chi_00002`（URキャラ）がボスとして最適
...
3. **ボスは作品を代表するキャラが順に登場**: chi_00001（デンジ系）→ chi_00201（ポチタ）→ chi_00002（URキャラ）の順にノーマルで登場
