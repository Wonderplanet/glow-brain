...
```
domain/tasks/masterdata-entry/{リリースキー}/generated/tables/{テーブル名}.csv
```

**例:**
```
domain/tasks/masterdata-entry/202602015/generated/tables/
  ├── MstSeries.csv
  ├── MstEvent.csv
  ├── OprGacha.csv
  ├── OprGachaPrize.csv
...
| 3 | **出力先** | デフォルト: `domain/tasks/masterdata-entry/{リリースキー}/generated/tables/` | 任意（デフォルト可） |
...
検証対象: `domain/tasks/masterdata-entry/{リリースキー}/generated/tables/`
