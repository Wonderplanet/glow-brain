...
```
@copilot /masterdata-creator <運営仕様ディレクトリパス>
```

### Examples

```
@copilot /masterdata-creator マスタデータ/運営仕様/100kanoイベント
@copilot /masterdata-creator マスタデータ/運営仕様/新規ガチャ/要件/新規ガチャ_仕様書_03_ガチャ設定.csv
```
...
User: `@copilot /masterdata-creator マスタデータ/運営仕様/100kanoイベント`
...
User: `@copilot /masterdata-creator マスタデータ/運営仕様/新規ガチャ/要件/新規ガチャ_仕様書_03_ガチャ設定.csv`
...
User: `@copilot /masterdata-creator マスタデータ/運営仕様/コラボガチャ`
