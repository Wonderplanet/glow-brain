...
**パス構成**:
- `マスタデータ/施策/[施策名]`: 施策ディレクトリ（要件フォルダと同階層）
...
マスタデータ/施策/[施策名]/
├── 要件/                  ← ユーザーが事前に用意
├── 要件ファイル構成.md     ← ステップ1で生成済み
├── [ModelName].csv        ← このステップで生成
└── REPORT.md              ← このステップで生成
```
...
└── 施策/
    └── [施策名]/
        ...
        ├── REPORT.md              ← このステップで生成
        ├── [ModelName1].csv       ← このステップで生成
        └── [ModelName2].csv       ← このステップで生成
```
...
├── REPORT.md                    ← これから生成
├── OprGacha.csv                 ← これから生成
├── OprGachaI18n.csv             ← これから生成
└── MstGachaPrizeGroup.csv       ← これから生成 (必要に応じて)
```
