...
```bash
# テンプレートファイルをコピー
cp projects/glow-masterdata/sheet_schema/[ModelName].csv マスタデータ/仕様/[要件を要約した日本語]/[ModelName].csv
```
...
```
マスタデータ/仕様/[要件を要約した日本語]/[ModelName].csv
```
...
```
マスタデータ/仕様/[要件を要約した日本語]/REPORT.md
```
