...
class MasterdataDownloader:
    ...
    def __init__(self, credentials_path: str, repo_path: str):
        ...
        Args:
            credentials_path: サービスアカウントの認証情報JSONファイルパス
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='GLOWマスタデータ設計書ダウンローダー'
    )
    parser.add_argument(
        'index_sheet_url',
        help='一覧シートのURL'
    ...
    parser.add_argument(
        ...
        help='サービスアカウント認証情報JSONファイルパス（デフォルト: credentials.json）'
    )
    parser.add_argument(
        '--repo-path',
