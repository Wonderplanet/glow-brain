...
return [
     ...
     * このテーブル名を課金・通過基盤ではデフォルト値とする。(ドキュメントなどでは、このデフォルトテーブル名を使用する)
    ...
    'store' => [
        ...
        'separate_currency_limit_check' => true,

        // 有償通貨の最大所有数
        // mst_config:USER_PAID_DIAMOND_MAX_AMOUNTと二重管理されているため注意すること
        'max_owned_paid_currency_amount' => 999999999,

        // 無償通貨の最大所有数
        // mst_config:USER_FREE_DIAMOND_MAX_AMOUNTと二重管理されているため注意すること
