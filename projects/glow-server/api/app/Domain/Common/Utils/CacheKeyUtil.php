...
class CacheKeyUtil
{
    ...
    /**
     * WebStore購入通知のキャッシュキー
     * @param string $usrUserId
     * @return string
     */
    public static function getWebStorePurchaseNotificationsKey(string $usrUserId): string
    {
        return "webstore:purchase:notifications:{$usrUserId}";
    }
}
