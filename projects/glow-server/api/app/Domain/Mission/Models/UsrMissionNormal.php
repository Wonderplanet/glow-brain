...
class UsrMissionNormal extends UsrModel implements UsrMissionNormalInterface, IUsrMission
{
    protected static string $tableName = 'usr_mission_normals';
