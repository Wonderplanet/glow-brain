...
/**
 * @property string $mst_mission_daily_bonus_id
 * @property int $status
 * @property ?string $cleared_at
 * @property ?string $received_reward_at
 */
class UsrMissionDailyBonus extends UsrEloquentModel implements UsrMissionDailyBonusInterface
{
    use HasFactory;
    ...
    {
        return $this->usr_user_id . $this->mst_mission_daily_bonus_id;
    }

    public function getMstMissionId(): string
    {
        return $this->mst_mission_daily_bonus_id;
    }
