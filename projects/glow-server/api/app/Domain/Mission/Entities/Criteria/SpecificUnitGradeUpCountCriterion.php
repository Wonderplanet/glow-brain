...
/**
 * 指定したユニットのグレードアップ回数がX回以上
 * criterion_type = SpecificUnitGradeUpCount
 * criterion_value = mst_units.id
 * criterion_count = X
 */
class SpecificUnitGradeUpCountCriterion extends MissionCriterion
{
    protected MissionCriterionType $type = MissionCriterionType::SPECIFIC_UNIT_GRADE_UP_COUNT;
