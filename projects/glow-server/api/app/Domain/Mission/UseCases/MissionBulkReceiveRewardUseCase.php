...
class MissionBulkReceiveRewardUseCase
{
    ...
    public function exec(
        ...
        $limitedTermAdventBattleFetchStatus = $limitedTermFetchStatus->getAdventBattleMissionFetchStatus();
        ...
        return new MissionBulkReceiveRewardResultData(
            ...
            $limitedTermAdventBattleFetchStatus->getUsrMissionStatusDataList(),
