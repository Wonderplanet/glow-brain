...
use App\Domain\Mission\Entities\Criteria\SpecificArtworkGradeLevelCriterion;
...
enum MissionCriterionType: string
{
    ...
    case SPECIFIC_ARTWORK_GRADE_LEVEL = 'SpecificArtworkGradeLevel';
    ...
    public function getCriterionClass(): ?string
    {
        return match ($this) {
            ...
            self::SPECIFIC_ARTWORK_GRADE_LEVEL => SpecificArtworkGradeLevelCriterion::class,
                // ユニット
    ...
    public static function needInstantClearTypes(): Collection
    {
        return collect([
            ...
            MissionCriterionType::SPECIFIC_ARTWORK_GRADE_LEVEL,
        ]);
    }
}
