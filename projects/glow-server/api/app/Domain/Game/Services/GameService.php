...
class GameService
{
    ...
    public function fetchOther(
        ...
        $usrArtworkParty = $this->artworkPartyService->getOrMakeDefault($usrUserId);
    ...
    public function fetchBadge(
        ...
        $unreceivedMissionArtworkPanelRewardCounts = $missionLimitedTermRewardData->getArtworkPanelCountMap();
