...
enum LogResourceTriggerSource: string
{
    ...
    // BOXガシャ排出物
    case BOX_GACHA_REWARD = 'BoxGachaReward';
    ...
    // スタミナ回復
    case USER_STAMINA_RECOVERY_COST = 'UserStaminaRecoveryCost';
    ...
    // ユニットグレードアップ報酬
    case UNIT_GRADE_UP_REWARD = 'UnitGradeUpReward';

    // 原画を直接配布していない状態で、原画のかけらを報酬として配布した結果、原画が完成した際の報酬
    case ARTWORK_FRAGMENT_COMPLETION_REWARD = 'ArtworkFragmentCompletionReward';
    ...
    // BOXガシャ抽選時に消費したコスト
    case BOX_GACHA_COST = 'BoxGachaCost';
