...
class PvpRankingReward extends PvpReward
{
    private int $expirationDays = MessageConstant::PVP_REWARD_MESSAGE_EXPIRATION_DAYS;
    private string $title = MessageConstant::PVP_RANKING_REWARD_TITLE;
    private string $body = MessageConstant::PVP_RANKING_REWARD_BODY;
    ...
    public function __construct(
        ...
        $logTriggerDto = new LogTriggerDto(
            LogResourceTriggerSource::PVP_RANKING_REWARD->value,
            $sysPvpSeasonId,
        );
        parent::__construct(
            $resourceType,
    ...
    {
        return [
            'rewardCategory' => PvpRewardCategory::RANKING->value,
