...
class UserDelegator
{
    ...
    public function findByBnUserId(string $bnUserId): ?UsrUserEntity
    {
        return $this->usrUserRepository->findByBnUserId($bnUserId)?->toEntity();
    }
     ...
     * @return void
     * @throws \App\Domain\Common\Exceptions\GameException ユーザーがBANされている場合
     */
