...
class PartyRoleTypeRuleChecker implements IRuleChecker
{
    ...
    public function checkRule(Collection $unitEntities): bool
    {
        $violationMstUnits = $unitEntities->filter(function ($unitEntity) {
            ...
            return !$this->ruleValues->contains($unitEntity->getMstUnit()->getRoleType());
        });
    ...
    public function getRuleInfo(): string
    {
        return sprintf(
            '%s [rule_value = %s]',
            PartyRuleType::PARTY_ROLE_TYPE->value,
