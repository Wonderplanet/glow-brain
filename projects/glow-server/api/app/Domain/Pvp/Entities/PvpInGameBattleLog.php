...
class PvpInGameBattleLog extends InGameBattleLog
{
    ...
    public function __construct(
        ...
        private readonly Collection $artworkPartyStatus,
        private readonly Collection $opponentArtworkPartyStatus,
    ) {
    }
     ...
     */
    public function getArtworkPartyStatus(): Collection
    {
        return $this->artworkPartyStatus;
    }

    /**
     * @return Collection<\App\Domain\Resource\Entities\ArtworkPartyStatus>
     */
    public function getOpponentArtworkPartyStatus(): Collection
    {
        return $this->opponentArtworkPartyStatus;
    }
    ...
    public function formatToLog(): array
    {
        return [
            ...
            'artwork_party_status' => $this->artworkPartyStatus
                ->map(fn($status) => $status->formatToLog())->toArray(),
            'opponent_artwork_party_status' => $this->opponentArtworkPartyStatus
                ->map(fn($status) => $status->formatToLog())->toArray(),
        ];
    }
}
