...
class PvpEndService
{
    public function __construct(
        ...
        private readonly ArtworkPartyDelegator $artworkPartyDelegator,
    ...
    private function getOpponentPvpStatus(
        ...
        // 原画パーティ
        $partyMstArtworkIds = $this->artworkPartyDelegator->getUsrArtworkParty(
            usrUserId: $usrUserId,
        )->getMstArtworkIds();

        $usrArtworks = $this->encyclopediaDelegator->getUsrArtworksByMstArtworkIds($usrUserId, $partyMstArtworkIds);
        $artworkPartyStatuses = $usrArtworks->map(function (UsrArtworkEntity $usrArtwork) {
        ...
        $pvpUserProfile = new OpponentSelectStatusData(
            ...
            winAddPoint: 0,
            matchingType: PvpMatchingType::None,
        );
        ...
        return new OpponentPvpStatusData(
            ...
            artworkPartyStatuses: $artworkPartyStatuses
        );
    }
