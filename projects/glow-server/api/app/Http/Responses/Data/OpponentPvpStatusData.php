...
class OpponentPvpStatusData
{
     ...
     * @param Collection<ArtworkPartyStatus> $artworkPartyStatuses
     */
    ...
    public function formatToResponse(): array
    {
        return [
            ...
            'artworkPartyStatuses' => $this->artworkPartyStatuses
                ->map(fn(ArtworkPartyStatus $status) => $status->formatToLog())
                ->values()->toArray(),
        ];
    }
