    ...
    private function createCurrencySummaryResponse(
        ...
        switch ($billingPlatform) {
            case CurrencyConstants::PLATFORM_APPSTORE:
                $paidAmount = $usrCurrencySummary->paid_amount_apple + $usrCurrencySummary->paid_amount_share;
                break;
            case CurrencyConstants::PLATFORM_GOOGLEPLAY:
                $paidAmount = $usrCurrencySummary->paid_amount_google + $usrCurrencySummary->paid_amount_share;
                break;
            default:
                $paidAmount = 0;
                break;
