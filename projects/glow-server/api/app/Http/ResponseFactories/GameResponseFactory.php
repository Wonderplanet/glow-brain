...
class GameResponseFactory
{
    ...
    public function createUpdateAndFetchResponse(GameUpdateAndFetchResultData $resultData): JsonResponse
    {
        ...
        $fetchOther = $this->responseDataFactory->addUsrPartyData(
            $fetchOther,
            $gameFetchOtherData->usrParties,
            true
        );
        $fetchOther = $this->responseDataFactory->addUsrArtworkPartyData(
            $fetchOther,
            collect([$gameFetchOtherData->usrArtworkParty->toEntity()]),
            false
        );
        ...
        $fetchOther = $this->responseDataFactory->addWebStorePurchaseProductSubIds($fetchOther, $gameFetchOtherData->unnotifiedProductSubIds);
