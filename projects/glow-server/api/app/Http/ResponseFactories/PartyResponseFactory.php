...
class PartyResponseFactory
{
    ...
    public function createArtworkPartySaveResponse(ArtworkPartySaveResultData $resultData): JsonResponse
    {
        $result = $this->responseDataFactory->addUsrArtworkPartyData([], collect([$resultData->usrArtworkParty]), false);
        return response()->json($result);
    }
}
