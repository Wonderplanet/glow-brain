...
class MissionResponseFactory
{
    ...
    public function createArtworkPanelUpdateAndFetchResponse(MissionArtworkPanelUpdateAndFetchResultData $resultData): JsonResponse
    {
        $result = [];

        $result = $this->responseDataFactory->addUsrLimitedTermMissionData(
            $result,
            $resultData->usrMissionLimitedTerms
        );
