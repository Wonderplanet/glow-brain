...
Route::middleware([
    ...
    Route::controller(Controllers\UnitController::class)->group(function () {
        ...
        Route::post('/unit/receive_grade_up_reward', 'receiveGradeUpReward');
    });
    ...
    Route::controller(Controllers\PartyController::class)->group(function () {
        ...
        Route::post('/party/artwork/save', 'artworkSave');
    });
    ...
    Route::controller(Controllers\MissionController::class)->group(function () {
        ...
        Route::post('/mission/artwork_panel_update_and_fetch', 'artworkPanelUpdateAndFetch');
    });
    ...
    Route::controller(Controllers\EncyclopediaController::class)->group(function () {
        ...
        Route::post('/encyclopedia/artwork/grade_up', 'artworkGradeUp');
    });
...
// 認証不要、署名検証のみ
Route::middleware([
    XsollaSignatureVerification::class,
])->group(function () {
    Route::controller(Controllers\ShopController::class)->group(function () {
        Route::post('/shop/webstore', 'webstore');
    });
});
