...
class CurrencyUserServiceTest extends TestCase
{
    ...
    public static function params_validateDiamond_ダイヤ不足の場合にLACK_OF_RESOURCESエラーになる()
    {
        return [
            ...
            'ios 無償ダイヤが1足りずエラー' => [PlatformConstant::PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 100, 99, 0, 0, true],
            'ios 有償ダイヤが1足りずエラー' => [PlatformConstant::PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 100, 0, 99, 0, true],
            'ios 無償と有償ダイヤの合算が1足りずエラー' => [PlatformConstant::PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 100, 1, 98, 0, true],

            'android 無償ダイヤが1足りずエラー' => [PlatformConstant::PLATFORM_ANDROID, CurrencyConstants::PLATFORM_GOOGLEPLAY, 100, 99, 0, 0, true],
            'android 有償ダイヤが1足りずエラー' => [PlatformConstant::PLATFORM_ANDROID, CurrencyConstants::PLATFORM_GOOGLEPLAY, 100, 0, 0, 99, true],
            'android 無償と有償ダイヤの合算が1足りずエラー' => [PlatformConstant::PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 100, 1, 0, 98, true],
