...
class MissionPvpWinCountAchievementCriterionTest extends TestCase
{
    ...
    public function test_missionUpdateHandleService_handleAllUpdateTriggeredMissions_進捗が更新されて未クリア()
    {
        ...
        $this->checkUsrMissionNormal($usrMissions['mst_mission_achievement_1'], MissionStatus::UNCLEAR, 1, $now, null, null);
        $this->checkUsrMissionNormal($usrMissions['mst_mission_achievement_2'], MissionStatus::UNCLEAR, 1, $now, null, null);
    }
    ...
    public function test_pvp_missionUpdateHandleService_handleAllUpdateTriggeredMissions_進捗が更新されてクリア()
    {
        ...
        UsrMissionNormal::factory()->create([
            ...
            'mst_mission_id' => 'mst_mission_achievement_1',
            'mission_type' => MissionType::ACHIEVEMENT->getIntValue(), // ACHIEVEMENT
        ...
        $usrMissions = UsrMissionNormal::query()->where('usr_user_id', $usrUserId)->get()->keyBy->getMstMissionId();
        $this->assertCount(2, $usrMissions);
        $this->checkUsrMissionNormal($usrMissions['mst_mission_achievement_1'], MissionStatus::CLEAR, 50, $now, $now, null);
        $this->checkUsrMissionNormal($usrMissions['mst_mission_achievement_2'], MissionStatus::UNCLEAR, 1, $now, null, null);
    }
}