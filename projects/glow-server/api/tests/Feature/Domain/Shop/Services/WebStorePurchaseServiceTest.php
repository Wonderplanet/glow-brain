...
class WebStorePurchaseServiceTest extends TestCase
{
    ...
    public function testProcessOrder_正常系_ダイヤモンド商品のアイテムが付与されること(): void
    {
        ...
        // Exercise
        $this->webStorePurchaseService->processOrder(
            $usrUserId,
            $orderId,
            $invoiceId,
            $currencyCode,
        ...
        $this->assertEquals(0, $usrCurrencySummaryEntity->getPaidAmountApple());
        $this->assertEquals(0, $usrCurrencySummaryEntity->getPaidAmountGoogle());
