...
class UserServiceTest extends TestCase
{
    ...
    public static function params_testCheckUserBan()
    {
        return [
            '正常なユーザー' => [
            ...
            '時限BAN(チート)で期限切れ' => [
                'status' => UserStatus::BAN_TEMPORARY_CHEATING->value,
                'suspendEndAt' => '2024-01-01 00:00:00',
                'errorCode' => null,
            ],
            '時限BAN(異常検知)で期限切れ' => [
                'status' => UserStatus::BAN_TEMPORARY_DETECTED_ANOMALY->value,
                'suspendEndAt' => '2024-01-01 00:00:00',
                'errorCode' => null,
            ],
            '時限BAN(チート)で期限内' => [
                'status' => UserStatus::BAN_TEMPORARY_CHEATING->value,
                'suspendEndAt' => '2024-12-31 23:59:59',
                'errorCode' => ErrorCode::USER_ACCOUNT_BAN_TEMPORARY_BY_CHEATING,
            ],
            '時限BAN(異常検知)で期限内' => [
                'status' => UserStatus::BAN_TEMPORARY_DETECTED_ANOMALY->value,
                'suspendEndAt' => '2024-12-31 23:59:59',
                'errorCode' => ErrorCode::USER_ACCOUNT_BAN_TEMPORARY_BY_DETECTED_ANOMALY,
            ],
            '時限BAN(チート)で終了日時未設定' => [
                'status' => UserStatus::BAN_TEMPORARY_CHEATING->value,
                'suspendEndAt' => null,
            ...
            '永久BAN' => [
                ...
                'suspendEndAt' => null,
                'errorCode' => ErrorCode::USER_ACCOUNT_BAN_PERMANENT,
            ],
            '削除済み' => [
                'status' => UserStatus::DELETED->value,
                'suspendEndAt' => null,
                'errorCode' => ErrorCode::USER_ACCOUNT_DELETED,
            ],
            '返金処理中' => [
                'status' => UserStatus::REFUNDING->value,
                'suspendEndAt' => null,
                'errorCode' => ErrorCode::USER_ACCOUNT_REFUNDING,
            ],
        ];
    }

    #[DataProvider('params_testCheckUserBan')]
    public function testCheckUserBan_BAN状態チェックができていること(int $status, ?string $suspendEndAt, ?int $errorCode): void
    {
        // Setup
        ...
        $now = $this->fixTime('2024-06-15 12:00:00');
        ...
        // Exercise
        $this->userService->checkUserBan($usrUserId, $now);
