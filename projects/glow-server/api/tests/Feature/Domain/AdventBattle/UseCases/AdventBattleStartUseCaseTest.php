...
class AdventBattleStartUseCaseTest extends TestCase
{
    ...
    public function test_exec_正常実行(bool $isChallengeAd)
    {
        ...
        // Exercise
        $this->useCase->exec($currentUser, $mstAdventBattleId, $partyNo, $isChallengeAd, $inGameBattleLog, $randomSeed);
        ...
        $this->assertEquals($randomSeed, $usrAdventBattleSession->getRandomSeed());
    ...
    public function test_exec_チャレンジ回数上限(bool $isChallengeAd)
    {
        ...
        $this->useCase->exec($currentUser, $mstAdventBattleId, $partyNo, $isChallengeAd, $inGameBattleLog, 0);
    }
    ...
    public function test_exec_ミッション進捗確認()
    {
        ...
        // Exercise
        $this->useCase->exec($currentUser, $mstAdventBattleId, $partyNo, false, $inGameBattleLog, 0);
