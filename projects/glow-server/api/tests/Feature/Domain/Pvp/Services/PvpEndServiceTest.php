...
class PvpEndServiceTest extends TestCase
{
    ...
    public function test_update_score_勝利時スコア更新(): void
    {
        ...
        $pvpInGameBattleLog = new PvpInGameBattleLog(
            ...
            1000, // maxDamage
            collect([]), // partyStatus
            collect([]), // opponentPartyStatus
            collect([]), // artworkPartyStatus
            collect([]), // opponentArtworkPartyStatus
        );
        // スコアを200に更新
    ...
    public function test_get_opponent_pvp_status_正常に生成できる(): void
    {
        ...
        // 原画データ
        $artworkId1 = 'artwork_test_001';
        $artworkId2 = 'artwork_test_002';
        $artworkGradeLevel1 = 3;
        $artworkGradeLevel2 = 2;
        ...
        UsrArtwork::factory()->create([
            'usr_user_id' => $usrUserId,
            'mst_artwork_id' => $artworkId1,
            'grade_level' => $artworkGradeLevel1,
        ]);
        UsrArtwork::factory()->create([
            'usr_user_id' => $usrUserId,
            'mst_artwork_id' => $artworkId2,
            'grade_level' => $artworkGradeLevel2,
        ]);
        ...
        UsrArtworkParty::factory()->create([
            'usr_user_id' => $usrUserId,
            'party_no' => 1,
            'mst_artwork_id_1' => $artworkId1,
            'mst_artwork_id_2' => $artworkId2,
        ...
        $check = [
            ...
            'artworkPartyStatuses' => [
                [
                    'mstArtworkId' => $artworkId1,
                    'gradeLevel' => $artworkGradeLevel1,
                ],
                [
                    'mstArtworkId' => $artworkId2,
                    'gradeLevel' => $artworkGradeLevel2,
                ],
            ],
        ];
