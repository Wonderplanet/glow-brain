...
class IdleIncentiveQuickReceiveByAdUseCaseTest extends TestCase
{
    private IdleIncentiveQuickReceiveByAdUseCase $useCase;

    public function setUp(): void
    {
        parent::setUp(); // TODO: Change the autogenerated stub

        $this->useCase = app(IdleIncentiveQuickReceiveByAdUseCase::class);
    }
    ...
    public function testExec_ユーザーレベルパック開放テスト()
    {
        ...
        MstIdleIncentive::factory()->create([
            ...
            'max_daily_ad_quick_receive_amount' => 5,
        ])->toEntity();
    ...
    public function test_exec_広告視聴でのクイック探索上限アップのパス効果が適用されること()
    {
        // Setup
        $usrUserId = $this->createUsrUser()->getUsrUserId();
        $mstQuest = MstQuest::factory()->create([
    ...
    public function test_exec_有効期限外の場合は広告視聴でのクイック探索上限アップのパス効果が適用されないこと()
    {
        // Setup
        $usrUserId = $this->createUsrUser()->getUsrUserId();
        $mstQuest = MstQuest::factory()->create([
        ...
        $this->useCase->exec($currentUser, UserConstant::PLATFORM_IOS);
    }
}
