...
class MissionControllerTest extends BaseControllerTestCase
{
    ...
    public function test_bulkReceiveReward_期間限定ミッション報酬一括受取の結合テスト()
    {
        ...
        $this->assertArrayHasKey('userLevel', $responseJson);
        $this->assertArrayHasKey('usrConditionPacks', $responseJson);
        $this->assertArrayHasKey('usrArtworkFragments', $responseJson);
        $this->assertArrayHasKey('usrArtworks', $responseJson);
    }

    public function test_artworkPanelUpdateAndFetch_正常にレスポンスが返る()
    {
        // Setup
        $usrUserId = $this->createUsrUser()->getId();
        ...
        MstArtworkFragment::factory()->create([
            'id' => 'artwork_fragment_1',
            'mst_artwork_id' => 'artwork_1',
        ]);

        MstArtworkPanelMission::factory()->create([
            'id' => 'artwork_panel_mission_1',
            'mst_artwork_id' => 'artwork_1',
            'initial_open_mst_artwork_fragment_id' => 'artwork_fragment_1',
        ...
        // Exercise
        $response = $this->sendRequest('artwork_panel_update_and_fetch');
        ...
        $response->assertExactJson([
            'usrMissionLimitedTerms' => [
                [
                    'mstMissionLimitedTermId' => 'mission_1',
                    'progress' => 50,
                    'isCleared' => false,
            ...
            'usrArtworkFragments' => [
                [
                    ...
                    'mstArtworkFragmentId' => 'artwork_fragment_1',
                ],
            ],
        ]);
    }
