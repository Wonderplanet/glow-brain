...
class ContentMaintenanceCheckTest extends TestCase
{
     ...
     * @return array
     */
    public function cleanupNeededApiProvider(): array
    {
        $needCleanupApiList = $this->getClassPrivateConstantValue(ContentMaintenanceCheck::class, 'NEED_CLEANUP_API_LIST');
