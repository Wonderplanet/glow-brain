...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Domain\Resource\Mst\Models\MstMissionDaily>
 */
class MstMissionDailyFactory extends Factory
{

    protected $model = MstMissionDaily::class;
