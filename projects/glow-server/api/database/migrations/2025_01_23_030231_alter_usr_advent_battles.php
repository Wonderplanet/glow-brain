...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('usr_advent_battles', function (Blueprint $table) {
            $table->string('received_raid_reward_group_id', 255)->nullable()->comment('mst_advent_battle_reward_groups.id')->after('received_rank_reward_group_id');
        });
    ...
    {
        Schema::table('usr_advent_battles', function (Blueprint $table) {
            $table->dropColumn('received_raid_reward_group_id');
        });
    }
};
