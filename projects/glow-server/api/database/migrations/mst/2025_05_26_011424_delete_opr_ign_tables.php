...
// -- Create syntax for TABLE 'opr_in_game_notices_i18n'
// CREATE TABLE `opr_in_game_notices_i18n` (
//   `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
//   `release_key` bigint NOT NULL DEFAULT '1',
//   `opr_in_game_notice_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'opr_in_game_notices.id',
