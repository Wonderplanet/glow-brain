...
return new class extends Migration
{
    ...
    {
        Schema::create('mst_artwork_effect_activation_rules', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mst_artwork_effect_activation_rules');
    }
};
