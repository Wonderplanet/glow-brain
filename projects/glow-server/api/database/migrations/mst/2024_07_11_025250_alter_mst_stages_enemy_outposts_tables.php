...
return new class extends Migration
{
    ...
    // 変更内容
    // MstStage: bgmAssetKeyの後にallyOutpostAssetKey(string not null)列を追加
    // MstEnemyOutpost: hpの後にoutpostAssetKey(string not null)列を追加
    ...
    public function up(): void
    {
        Schema::table('mst_stages', function (Blueprint $table) {
            $table->string('ally_outpost_asset_key')->nullable(false)->after('bgm_asset_key');
        });

        Schema::table('mst_enemy_outposts', function (Blueprint $table) {
            $table->string('outpost_asset_key')->nullable(false)->after('hp');
        });
    }
    ...
    {
        Schema::table('mst_stages', function (Blueprint $table) {
            $table->dropColumn('ally_outpost_asset_key');
        });

        Schema::table('mst_enemy_outposts', function (Blueprint $table) {
            $table->dropColumn('outpost_asset_key');
        });
    }
};
