...
return new class extends Migration {
    ...
    // `base_coin_amount` decimal(6,4) NOT NULL COMMENT 'N分ごとのコインの基礎獲得数',
    // `base_exp_amount` decimal(6,4) NOT NULL COMMENT 'N分ごとの経験値の基礎獲得数',
    ...
    // `base_rank_up_material_amount` decimal(6,4) NOT NULL DEFAULT '1.00' COMMENT 'リミテッドメモリーのベース獲得量',
    // PRIMARY KEY (`id`)
    ...
    // `base_amount` decimal(6,4) NOT NULL COMMENT 'ベース量',
    // PRIMARY KEY (`id`)
