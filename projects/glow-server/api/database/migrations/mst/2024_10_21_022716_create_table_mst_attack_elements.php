...
return new class extends Migration
{
    ...
    //     `range_start_type` enum('Distance','Koma','KomaLine') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    //     `range_start_parameter` double(8,2) NOT NULL,
    //     `range_end_type` enum('Distance','Koma','KomaLine') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    // 変更内容
    // range_start_typeとrange_end_typeのenumにPageを追加
    ...
    public function up(): void
    {
        ...
        Schema::table('mst_attack_elements', function (Blueprint $table) {
            DB::statement('ALTER TABLE mst_attack_elements MODIFY COLUMN range_start_type ENUM("Distance","Koma","KomaLine","Page") CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
            DB::statement('ALTER TABLE mst_attack_elements MODIFY COLUMN range_end_type ENUM("Distance","Koma","KomaLine","Page") CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        });
    }
    ...
    {
        Schema::table('mst_attack_elements', function (Blueprint $table) {
            DB::statement('ALTER TABLE mst_attack_elements MODIFY COLUMN range_start_type ENUM("Distance","Koma","KomaLine") CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
            DB::statement('ALTER TABLE mst_attack_elements MODIFY COLUMN range_end_type ENUM("Distance","Koma","KomaLine") CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL');
        });
    }
};
