...
return new class extends Migration
{
    ...
    // 変更内容
    // MstStage: Rename: allyOutpostAssetKey > playerOutpostAssetKey
    ...
    public function up(): void
    {
        ...
        Schema::table('mst_stages', function (Blueprint $table) {
            $table->renameColumn('ally_outpost_asset_key', 'player_outpost_asset_key');
        });
    }
    ...
    public function down(): void
    {
        //
        Schema::table('mst_stages', function (Blueprint $table) {
            $table->renameColumn('player_outpost_asset_key', 'ally_outpost_asset_key');
        });
    }
};
