...
return new class extends Migration
{
    ...
    //  `unit_label` enum('DropN','DropR','DropSR','DropSSR','DropUR','PremiumN','PremiumR','PremiumSR','PremiumSSR','PremiumUR','FestivalUR') COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    //  `unit_label` enum('DropN','DropR','DropSR','DropSSR','DropUR','PremiumN','PremiumR','PremiumSR','PremiumSSR','PremiumUR','FestivalUR') COLLATE utf8mb4_bin NOT NULL,
     ...
     * 変更内容
     *
     * unit_labelからDropNとPremiumNを削除追加
     */
