...
return new class extends Migration
{
    ...
    {
        Schema::create('mst_mission_limited_term_dependencies', function (Blueprint $table) {
            ...
            $table->unique(['group_id', 'mst_mission_limited_term_id'], 'group_id_mst_mission_limited_term_id_unique');
    ...
    {
        Schema::dropIfExists('mst_mission_limited_term_dependencies');
    }
};
