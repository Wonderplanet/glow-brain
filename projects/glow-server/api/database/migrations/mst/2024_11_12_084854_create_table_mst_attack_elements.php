...
return new class extends Migration
{
    ...
    //     `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    //     `ability_type` enum('None','SlipDamageKomaBlock','AttackPowerDownKomaBlock','GustKomaBlock','AttackPowerUpKomaBoost','WindKomaBoost','AttackPowerUpInNormalKoma','MoveSpeedUpInNormalKoma','DamageCutInNormalKoma') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    //     `release_key` bigint NOT NULL DEFAULT '1',
    ...
    public function up(): void
    {
        ...
        Schema::table('mst_attack_elements', function (Blueprint $table) {
            $table->string('effect_type', 255)->default('None')->change();
        });

        Schema::table('mst_abilities', function (Blueprint $table) {
            $table->string('ability_type', 255)->default('None')->change();
        });
    }
    ...
    {
        Schema::table('mst_attack_elements', function (Blueprint $table) {
            DB::statement('ALTER TABLE mst_attack_elements MODIFY effect_type enum("None","AttackPowerUp","AttackPowerDown","DamageCut","AttackSpeedDown","MoveSpeedUp","MoveSpeedDown","SlipDamage","Fierce","SpecialAttackSeal","SlipDamageKomaBlock","AttackPowerDownKomaBlock","GustKomaBlock","AttackPowerUpKomaBoost","AttackPowerUpInNormalKoma","MoveSpeedUpInNormalKoma","DamageCutInNormalKoma","Poison","PoisonBlock","Burn","BurnBlock") DEFAULT NULL');
        });

        Schema::table('mst_abilities', function (Blueprint $table) {
            DB::statement('ALTER TABLE mst_abilities MODIFY ability_type enum("None","SlipDamageKomaBlock","AttackPowerDownKomaBlock","GustKomaBlock","AttackPowerUpKomaBoost","WindKomaBoost","AttackPowerUpInNormalKoma","MoveSpeedUpInNormalKoma","DamageCutInNormalKoma")');
        });
    }
};
