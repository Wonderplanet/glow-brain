...
class CurrencyPaidDetail implements FromCollection, WithTitle, WithStyles, ShouldAutoSize, WithColumnFormatting
{
    use Exportable;
    ...
    public function collection(): Collection
    {
        ...
        $this->summaryCollection
            ->sortBy('pricePerAmount')
            ->map(function (array $row) use (&$list) {
                $list[] = [
    ...
    public function title(): string
    {
        return match ($this->billingPlatform) {
            CurrencyConstants::PLATFORM_APPSTORE => '日本Apple(内訳)',
            CurrencyConstants::PLATFORM_GOOGLEPLAY => '日本Google(内訳)',
            default => '日本累計(内訳)',
        };
    }
