...
class UsrCurrencySummaryRepository
{
    ...
    private function updateCurrencySummaryPaidAndFreeInternal(
        ...
        switch ($billingPlatform) {
            case CurrencyConstants::PLATFORM_APPSTORE:
                $this->updateCurrencySummaryInternal($userId, $paidAmount, null, $freeAmount);
                break;
            case CurrencyConstants::PLATFORM_GOOGLEPLAY:
                $this->updateCurrencySummaryInternal($userId, null, $paidAmount, $freeAmount);
                break;
            default:
    ...
    {
        $this->updateCurrencySummaryInternal($userId, null, null, $freeAmount);
    }
    ...
    {
        $this->updateCurrencySummaryInternal($userId, 0, 0, 0);
    }
