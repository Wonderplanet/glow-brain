...
/**
 * 無償一次通貨の返却を行なった際のログと通貨ログの紐付け用クラス
 ...
 * @property string $log_currency_free_id  この返却操作で記録されたログ
 * @property string $revert_log_currency_free_id  返却操作の対象になった、返却個数が記録されたログ
 * @property \Illuminate\Support\Carbon $created_at
 * @property \Illuminate\Support\Carbon $updated_at
 */
class LogCurrencyRevertHistoryFreeLog extends BaseLogModel
{
}
