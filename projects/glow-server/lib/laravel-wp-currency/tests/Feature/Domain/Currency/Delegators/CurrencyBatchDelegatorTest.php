...
class CurrencyBatchDelegatorTest extends TestCase
{
    use RefreshDatabase;

    private CurrencyBatchDelegator $currencyBatchDelegator;
    ...
    public function setUp(): void
    {
        ...
        $this->currencyBatchDelegator = $this->app->make(CurrencyBatchDelegator::class);
    ...
    public function collectFreeCurrencyByBatch_無償一次通貨を回収するチェック(string $type): void
    {
        // Setup
        // 通貨管理の登録
        ...
        // Exercise
        $this->currencyBatchDelegator->collectFreeCurrencyByBatch(
            '1',
            $type,
            100,
    ...
    public function addFreeCurrencyByBatch_正常処理チェック(string $type): void
    {
        ...
        // Exercise
        $this->currencyBatchDelegator->addFreeCurrencyByBatch(
            $userId,
            $type,
            $amount,
            $triggerDetail
