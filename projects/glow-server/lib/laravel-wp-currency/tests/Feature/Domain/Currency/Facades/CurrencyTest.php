...
class CurrencyTest extends TestCase
{
    ...
    {
        // Exercise
        $usrCurrencySummary = Currency::createUser('1', CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 100);
    ...
    public function createUser_すでに登録されていたらその情報が戻ること()
    {
        ...
        $freeAmount = 100;
        // 最初の登録
        $usrCurrencySummary = Currency::createUser($userId, CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, $freeAmount);

        // Exercise
        // おなじユーザーで再度登録
        $usrCurrencySummary = Currency::createUser($userId, CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 200);
    ...
    {
        // Setup
        Currency::createUser('1', CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 100);

        // Exercise
        Currency::addFree('1', CurrencyConstants::OS_PLATFORM_IOS, 100, CurrencyConstants::FREE_CURRENCY_TYPE_INGAME, new Trigger('', '', '', ''));

        // Verify
        $usrCurrencySummary = Currency::getCurrencySummary('1');
    ...
    {
        // Setup
        Currency::createUser('1', CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 10);
        // 登録する無償一次通貨
        $freeCurrencies = [
        ...
        // Exercise
        Currency::addFrees('1', CurrencyConstants::OS_PLATFORM_IOS, $freeCurrencies);
    ...
    public function usePaid_有償一次通貨の消費()
    {
        ...
        // Exercise
        Currency::usePaid('1', CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 99, new Trigger('', '', '', ''));
    ...
    public function useCurrency_無償・有償一次通貨の消費()
    {
        ...
        // Exercise
        Currency::useCurrency('1', CurrencyConstants::OS_PLATFORM_IOS, CurrencyConstants::PLATFORM_APPSTORE, 99, new Trigger('', '', '', ''));
    ...
    public function getCurrencyPaid_有償一次通貨情報を取得する()
    {
        ...
        // Exercise
        $result = Currency::getCurrencyPaid('1', CurrencyConstants::PLATFORM_APPSTORE);
    ...
    public function softDeleteCurrencyAndBillingDataByUserId_課金・通貨データを論理削除する()
    {
        ...
        // Exercise
        Currency::softDeleteCurrencyAndBillingDataByUserId('1', CurrencyConstants::OS_PLATFORM_IOS);
    ...
    {
        // Exercise
        $actual = Currency::getMaxOwnedCurrencyAmount();
    ...
    {
        // Exercise
        $actual = Currency::isMaxOwnedCurrencyAmountUnlimited();
