...
class CurrencyDebugDelegatorTest extends TestCase
{
    use RefreshDatabase;

    private CurrencyDelegator $currencyDelegator;
    private CurrencyDebugDelegator $currencyDebugDelegator;
    ...
    public function setUp(): void
    {
        ...
        $this->currencyDebugDelegator = $this->app->make(CurrencyDebugDelegator::class);
    ...
    public function addCurrencyPaid_有償一次通貨を追加する()
    {
        ...
        // Exercise
        $this->currencyDebugDelegator->addCurrencyPaid(
            '1',
