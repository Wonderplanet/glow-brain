...
namespace MasterAssetReleaseAdmin\Unit\Delegators;
...
class MasterAssetReleaseAdminDelegatorTest extends TestCase
{
    // fixtures/defaultのmng_master_releasesのデータを投入させない
    protected bool $ignoreDefaultCsvImport = true;
    
    private MasterAssetReleaseAdminDelegator $masterAssetReleaseAdminDelegator;

    public function setUp(): void
    {
        parent::setUp();

        $this->masterAssetReleaseAdminDelegator = app(MasterAssetReleaseAdminDelegator::class);
    }
    ...
    public function registerAsset_データなし_リリースフラグON()
    {
        ...
        // Exercise
        $this->masterAssetReleaseAdminDelegator->registerAsset($request);
    ...
    public function getAssetReleaseData_アセットバージョンデータ取得(int $platform)
    {
        ...
        // Exercise
        $response = $this->masterAssetReleaseAdminDelegator->getAssetReleaseData($platform, $targetReleaseKey);
    ...
    public function getMasterReleaseData_データ取得チェック(): void
    {
        ...
        // Exercise
        $response = $this->masterAssetReleaseAdminDelegator->getMasterReleaseData([2024083101, 2024090101, 2024090102, 2024090103]);
