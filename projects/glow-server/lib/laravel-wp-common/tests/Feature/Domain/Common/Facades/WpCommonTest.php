...
namespace WonderPlanet\Tests\Feature\Domain\Common\Facades;
...
class WpCommonTest extends TestCase
{
    ...
    public function getApiRequestId_リクエストID取得()
    {
        ...
        // Exercise
        $result = WpCommon::getApiRequestId();
        // 二回呼び出しても同じ値が返ることを確認
        $result2 = WpCommon::getApiRequestId();
    ...
    public function getClientRequestId_クライアントのrequest_id取得()
    {
        ...
        // Exercise
        $result = WpCommon::getClientRequestId();
        // 二回呼び出しても同じ値が返ることを確認
        $result2 = WpCommon::getClientRequestId();
    ...
    public function getFrontRequestId_フロントのrequest_id取得(
        ...
        // Exercise
        $result = WpCommon::getFrontRequestId();
        // 二回呼び出しても同じ値が返ることを確認
        $result2 = WpCommon::getFrontRequestId();
