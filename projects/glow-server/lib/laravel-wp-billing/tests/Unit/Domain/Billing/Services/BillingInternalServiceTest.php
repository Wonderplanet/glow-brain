...
class BillingInternalServiceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function setUp(): void
    {
        ...
        $this->billingInternalService = $this->app->make(BillingInternalService::class);
    ...
    #[Test]
    public function softDeleteBillingDataByUserId_課金に関連するユーザーデータを論理削除する()
    {
        // Setup
        //  購入許可情報を登録
        ...
        // Exercise
        $this->billingInternalService->softDeleteBillingDataByUserId('1');
    ...
    #[Test]
    public function getUsrStoreProductHistoryCollectionByUserIdAndBillingPlatformAndReceiptUniqueIds_正常取得(): void
    {
        // Setup
        $userId = '1';
        ...
        // Exercise
        $usrStoreProductHistories = $this->billingInternalService
        ...
        //  取得内容のチェック
        $result1 = $usrStoreProductHistories->first(fn ($row) => $row['receipt_unique_id'] === 'receipt_unique_id_1-1');
        ...
        $result2 = $usrStoreProductHistories->first(fn ($row) => $row['receipt_unique_id'] === 'receipt_unique_id_1-2');
    ...
    #[Test]
    public function getUsrStoreProductHistoryCollectionByUserIdAndBillingPlatformAndReceiptUniqueIds_空情報を返す(): void
    {
        // Setup
        $userId = '1';
        $billingPlatform = CurrencyConstants::PLATFORM_APPSTORE;
        ...
        // Verify
        $this->assertEmpty($usrStoreProductHistories);
    }
}
