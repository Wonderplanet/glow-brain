...
<div>
    <span class="custom-topbar">
        ...
        <span class="info-item"><span class="font-bold">mstDB</span>: {{$currentMstDatabase}}</span><span class="separator">|</span>
        <span class="info-item"><span class="font-bold">API</span>: {{$apiVersion}}</span><span class="separator">|</span>
        <span class="info-item"><span class="font-bold">Admin</span>: {{$adminVersion}}</span>
    </span>
</div>
