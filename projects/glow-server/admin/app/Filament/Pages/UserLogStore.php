...
class UserLogStore extends UserDataBasePage implements HasTable
{
    ...
    private function table(Table $table)
    {
        ...
        $ids = array_unique($query->pluck('mst_store_product_id')->toArray());
        $oprProducts = OprProduct::query()
            ->whereIn('mst_store_product_id', $ids)
            ->get()
            ->keyBy('mst_store_product_id');
            ...
            ->filters([
                ...
                SelectFilter::make('billing_platform')
                    ->options([
                        ...
                        CurrencyConstants::PLATFORM_WEBSTORE => CurrencyConstants::PLATFORM_WEBSTORE
                    ])
