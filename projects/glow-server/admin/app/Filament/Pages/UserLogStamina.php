...
class UserLogStamina extends UserDataBasePage implements HasTable
{
    ...
    protected static string $view = 'filament.pages.user-log-stamina';
    public string $currentTab = UserSearchTabs::LOG_STAMINA->value;
