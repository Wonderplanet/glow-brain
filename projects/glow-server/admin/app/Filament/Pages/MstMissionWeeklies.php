...
class MstMissionWeeklies extends MissionDataBasePage implements HasTable
{
    use InteractsWithTable;

    protected static string $view = 'filament.pages.mst-mission-weeklies';
    public string $currentTab = MissionTabs::MISSION_WEEKLY->value;
    protected static ?string $title = MissionTabs::MISSION_WEEKLY->value;
        ...
        return $table
            ...
            ->columns([
                ...
                ->url(function (Model $record) {
                    return MstMissionWeeklyDetail::getUrl([
                        'mstMissionWeeklyId' => $record->id,
                    ]);
                }),
