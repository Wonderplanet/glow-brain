...
abstract class UserDataBasePage extends Page
{
    ...
    public array $tabGroups = [
        [
            ...
            'ガシャ' => [
                ...
                UserSearchTabs::BOX_GACHA->value => 'user-box-gacha',
            ],
            '降臨バトル' => [
        ...
        [
            ...
            'ガシャ履歴' => [
                ...
                UserSearchTabs::LOG_BOX_GACHA_ACTION->value => 'user-log-box-gacha-action',
            ],
            '強化履歴' => [
    ...
    public function billingInfoList(): InfoList
    {
        ...
        $usrCurrencySummaryCollection = UsrCurrencySummary::query()
            ->where('usr_user_id', $this->userId)
            ->get(['paid_amount_apple','paid_amount_google','paid_amount_share','free_amount']);
        ...
        $paidAmountShare = $usrCurrencySummary?->getPaidAmountShare();
        ...
        $state = [
            ...
            'WebStoreプリズム：合計 ' . $paidAmountShare .'個　' .
