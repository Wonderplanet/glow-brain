...
class MstMissionEventDailies extends MissionDataBasePage implements HasTable
{
    use InteractsWithTable;
    use InteractsWithInfolists;

    protected static string $view = 'filament.pages.mst-mission-event-dailies';

    public string $currentTab = MissionTabs::MISSION_EVENT_DAILY->value;
    protected static ?string $title = MissionTabs::MISSION_EVENT_DAILY->value;
            ...
            ->actions([
                Action::make('detail')
                    ...
                    ->url(function (Model $record) {
                        return MstMissionEventDailyDetail::getUrl([
                            'mstMissionEventDailyId' => $record->id,
                        ]);
                    }),
