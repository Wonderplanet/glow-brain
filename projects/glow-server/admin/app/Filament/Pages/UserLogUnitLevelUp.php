...
use App\Models\Log\LogUnitLevelUp;
...
class UserLogUnitLevelUp extends UserDataBasePage implements HasTable
{
    ...
    protected static string $view = 'filament.pages.user-log-unit-level-up';

    public string $currentTab = UserSearchTabs::LOG_UNIT_LEVEL_UP->value;
        ...
        return $table
            ...
            ->headerActions([
                SimpleCsvDownloadAction::make()
                    ->fileName('user_log_unit_level_up')
            ]);
    }
}
