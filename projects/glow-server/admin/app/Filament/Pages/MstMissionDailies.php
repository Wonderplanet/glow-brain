...
class MstMissionDailies extends MissionDataBasePage implements HasTable
{
    use InteractsWithTable;

    protected static string $view = 'filament.pages.mst-mission-dailies';
    public string $currentTab = MissionTabs::MISSION_DAILY->value;
    protected static ?string $title = MissionTabs::MISSION_DAILY->value;
        ...
        return $table
            ...
            ->columns([
                ...
                ->url(function (Model $record) {
                    return MstMissionDailyDetail::getUrl([
                        'mstMissionDailyId' => $record->id,
                    ]);
                }),
