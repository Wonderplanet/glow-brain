...
use App\Filament\Pages\PvpRankingRegenerations;
use App\Filament\Resources\PvpRankingResource\Pages;
...
class PvpRankingResource extends Resource
{
    use Authorizable;
    ...
    protected static ?string $modelLabel = 'ランクマッチランキング';
        ...
        return $table
            ...
            ->actions([
                ...
                ->url(function (Model $record) {
                    return PvpRankingRegenerations::getUrl([
    ...
    {
        return [
            'index' => Pages\ListPvpRankings::route('/'),
        ];
    }
}
