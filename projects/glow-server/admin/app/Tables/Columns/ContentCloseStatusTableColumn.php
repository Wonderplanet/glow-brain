 ...
 * 開催ステータスのテーブルカラム
 */
class ContentCloseStatusTableColumn extends TextColumn
{
    /**
    ...
    public function setStartAtColumnName(string $startAtColumnName): self
    {
    ...
    public function setEndAtColumnName(string $endAtColumnName): self
    {
