...
class GachaSimulationExcelService
{
    ...
    public function downloadGachaResults(
        ...
        return Response::streamDownload(
            ...
            name: $this->getFileName($oprGachaId, $gachaName, $simulationDate, $prizeType->value, $stepNumber),
    ...
    private function getFileName(
        ...
        $name = "GLOW_{$oprGachaId}_{$gachaName}_{$prizeType}";
        if (!is_null($stepNumber)) {
            $name .= "_step{$stepNumber}";
        }
        return $name . "_{$simulationDate->format('YmdHis')}.xlsx";
    }
