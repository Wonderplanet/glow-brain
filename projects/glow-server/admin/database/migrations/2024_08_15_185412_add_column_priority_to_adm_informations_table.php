...
return new class extends Migration
{
    ...
    //     `html_json` json NOT NULL COMMENT '本文のhtmlのjsonデータ',
    ...
    // 変更内容
    // adm_informationsのpriority列(unsigned int型 not null)を追加。コメント：表示優先度
    // enableの後に追加
    ...
    public function up(): void
    {
        Schema::table('adm_informations', function (Blueprint $table) {
            $table->unsignedInteger('priority')->after('enable')->comment('表示優先度');
        });
    }
