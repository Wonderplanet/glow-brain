...
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_receive_message_rewards` (
    ...
    `received_reward` string COMMENT '配布報酬情報',
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_receive_message_rewards'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_receive_message_rewards/${dt}/'
);
