-- log_staminas
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_staminas` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_staminas'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_staminas/${dt}/'
);
