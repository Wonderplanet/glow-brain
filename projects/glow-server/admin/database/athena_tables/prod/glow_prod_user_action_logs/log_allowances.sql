-- log_allowances
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_allowances` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_allowances'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_allowances/${dt}/'
);
