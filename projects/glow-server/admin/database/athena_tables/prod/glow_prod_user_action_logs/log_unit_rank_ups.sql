-- log_unit_rank_ups
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_unit_rank_ups` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_unit_rank_ups'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_unit_rank_ups/${dt}/'
);
