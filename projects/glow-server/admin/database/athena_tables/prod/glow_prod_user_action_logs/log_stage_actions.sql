-- log_stage_actions
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_stage_actions` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_stage_actions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_stage_actions/${dt}/'
);
