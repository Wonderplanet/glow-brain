-- log_emblems
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_emblems` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_emblems'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_emblems/${dt}/'
);
