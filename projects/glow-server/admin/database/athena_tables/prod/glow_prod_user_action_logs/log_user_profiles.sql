-- log_user_profiles
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_user_profiles` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_user_profiles'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_user_profiles/${dt}/'
);
