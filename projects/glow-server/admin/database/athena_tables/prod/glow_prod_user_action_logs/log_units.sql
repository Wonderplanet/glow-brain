-- log_units
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_units` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_units'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_units/${dt}/'
);
