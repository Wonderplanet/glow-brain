-- log_exps
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_exps` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_exps'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_exps/${dt}/'
);
