...
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_currency_revert_history_paid_logs` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_currency_revert_history_paid_logs'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_currency_revert_history_paid_logs/${dt}/'
);
