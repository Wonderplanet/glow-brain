-- log_user_levels
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_user_levels` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_user_levels'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_user_levels/${dt}/'
);
