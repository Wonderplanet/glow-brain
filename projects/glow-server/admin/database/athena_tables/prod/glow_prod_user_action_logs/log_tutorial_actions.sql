...
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_tutorial_actions` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_tutorial_actions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_tutorial_actions/${dt}/'
);
