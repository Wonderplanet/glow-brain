-- log_items
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_items` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_items'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_items/${dt}/'
);
