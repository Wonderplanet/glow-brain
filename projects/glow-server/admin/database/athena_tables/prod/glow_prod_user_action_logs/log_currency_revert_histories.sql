...
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_currency_revert_histories` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_currency_revert_histories'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_currency_revert_histories/${dt}/'
);
