-- log_mission_rewards
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_mission_rewards` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_mission_rewards'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_mission_rewards/${dt}/'
);
