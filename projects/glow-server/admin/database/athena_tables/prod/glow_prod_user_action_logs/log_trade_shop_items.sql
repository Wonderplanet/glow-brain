...
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_trade_shop_items` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_trade_shop_items'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_trade_shop_items/${dt}/'
);
