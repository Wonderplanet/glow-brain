-- log_currency_paids
CREATE EXTERNAL TABLE `glow_prod_user_action_logs`.`log_currency_paids` (
...
LOCATION
  's3://glow-prod-datalake/raw/tidb/log_currency_paids'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-prod-datalake/raw/tidb/log_currency_paids/${dt}/'
);
