-- log_mission_rewards
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_mission_rewards` (
    ...
    `mission_type` string COMMENT 'ミッションタイプ',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_mission_rewards'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_mission_rewards/${dt}/'
);
