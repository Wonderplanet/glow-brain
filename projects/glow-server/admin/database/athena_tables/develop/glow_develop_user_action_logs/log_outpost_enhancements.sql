...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_outpost_enhancements` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_outpost_enhancements'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_outpost_enhancements/${dt}/'
);
