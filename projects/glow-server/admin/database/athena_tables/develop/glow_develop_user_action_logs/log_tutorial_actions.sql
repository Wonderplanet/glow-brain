...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_tutorial_actions` (
    ...
    `tutorial_name` string COMMENT 'mst_tutorials.function_name,プレイしたチュートリアル名',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_tutorial_actions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_tutorial_actions/${dt}/'
);
