...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_google_play_refunds` (
    `id` string COMMENT '',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_google_play_refunds'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_google_play_refunds/${dt}/'
);
