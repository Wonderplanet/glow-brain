...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_advent_battle_actions` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_advent_battle_actions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_advent_battle_actions/${dt}/'
);
