...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_artwork_fragments` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_artwork_fragments'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_artwork_fragments/${dt}/'
);
