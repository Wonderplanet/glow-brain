...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_encyclopedia_rewards` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_encyclopedia_rewards'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_encyclopedia_rewards/${dt}/'
);
