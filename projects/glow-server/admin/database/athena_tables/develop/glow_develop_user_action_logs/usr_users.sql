-- usr_users
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`usr_users` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/usr_users'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/usr_users/${dt}/'
);
