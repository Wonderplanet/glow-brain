-- log_exps
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_exps` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_exps'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_exps/${dt}/'
);
