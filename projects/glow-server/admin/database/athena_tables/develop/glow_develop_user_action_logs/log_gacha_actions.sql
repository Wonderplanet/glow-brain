-- log_gacha_actions
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_gacha_actions` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_gacha_actions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_gacha_actions/${dt}/'
);
