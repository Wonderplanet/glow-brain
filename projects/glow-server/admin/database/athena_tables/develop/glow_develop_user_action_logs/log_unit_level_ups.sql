-- log_unit_level_ups
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_unit_level_ups` (
    ...
    `mst_unit_id` string COMMENT 'レベルアップしたユニット(mst_units.id)',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_unit_level_ups'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_unit_level_ups/${dt}/'
);
