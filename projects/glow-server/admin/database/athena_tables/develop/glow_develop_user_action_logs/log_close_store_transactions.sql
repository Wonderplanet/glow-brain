...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_close_store_transactions` (
    `id` string COMMENT '',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_close_store_transactions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_close_store_transactions/${dt}/'
);
