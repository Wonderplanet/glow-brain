...
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_idle_incentive_rewards` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_idle_incentive_rewards'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_idle_incentive_rewards/${dt}/'
);
