-- log_gachas
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_gachas` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_gachas'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_gachas/${dt}/'
);
