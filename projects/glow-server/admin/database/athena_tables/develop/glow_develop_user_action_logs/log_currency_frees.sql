-- log_currency_frees
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_currency_frees` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_currency_frees'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_currency_frees/${dt}/'
);
