-- log_ad_free_plays
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_ad_free_plays` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_ad_free_plays'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_ad_free_plays/${dt}/'
);
