-- log_banks
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_banks` (
    `id` string COMMENT '',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_banks'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_banks/${dt}/'
);
