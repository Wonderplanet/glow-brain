-- log_coins
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_coins` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_coins'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_coins/${dt}/'
);
