-- log_stores
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_stores` (
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_stores'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_stores/${dt}/'
);
