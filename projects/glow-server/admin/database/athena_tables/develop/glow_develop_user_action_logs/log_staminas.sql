-- log_staminas
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_staminas` (
    ...
    `before_amount` int COMMENT '変動前の量',
    `after_amount` int COMMENT '変動後の量',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_staminas'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_staminas/${dt}/'
);
