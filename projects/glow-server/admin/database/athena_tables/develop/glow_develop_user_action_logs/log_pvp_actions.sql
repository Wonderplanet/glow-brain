-- log_pvp_actions
CREATE EXTERNAL TABLE `glow_develop_user_action_logs`.`log_pvp_actions` (
    `id` string COMMENT '',
...
LOCATION
  's3://glow-develop-datalake/raw/tidb/log_pvp_actions'
TBLPROPERTIES (
  'classification'='csv',
  ...
  'storage.location.template' = 's3://glow-develop-datalake/raw/tidb/log_pvp_actions/${dt}/'
);
