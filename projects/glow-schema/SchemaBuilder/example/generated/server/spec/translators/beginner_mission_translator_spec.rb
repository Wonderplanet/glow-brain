...
RSpec.describe "BeginnerMissionTranslator" do
  subject { BeginnerMissionTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(BeginnerMissionViewModel)).to be_truthy
