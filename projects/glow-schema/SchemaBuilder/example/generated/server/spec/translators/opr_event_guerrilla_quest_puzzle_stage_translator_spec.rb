...
RSpec.describe "OprEventGuerrillaQuestPuzzleStageTranslator" do
  subject { OprEventGuerrillaQuestPuzzleStageTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(OprEventGuerrillaQuestPuzzleStageViewModel)).to be_truthy
