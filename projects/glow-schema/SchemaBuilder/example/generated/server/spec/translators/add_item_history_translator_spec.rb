...
RSpec.describe "AddItemHistoryTranslator" do
  subject { AddItemHistoryTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(AddItemHistoryViewModel)).to be_truthy
