...
RSpec.describe "PuzzleResultDropTranslator" do
  subject { PuzzleResultDropTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(PuzzleResultDropViewModel)).to be_truthy
