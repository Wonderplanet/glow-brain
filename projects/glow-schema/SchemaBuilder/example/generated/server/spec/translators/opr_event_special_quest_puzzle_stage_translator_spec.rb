...
RSpec.describe "OprEventSpecialQuestPuzzleStageTranslator" do
  subject { OprEventSpecialQuestPuzzleStageTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(OprEventSpecialQuestPuzzleStageViewModel)).to be_truthy
