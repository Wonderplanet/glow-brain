...
RSpec.describe "OprEventSquestPstageOpponentTranslator" do
  subject { OprEventSquestPstageOpponentTranslator.translate(use_case_data) }

  context do
    let(:use_case_data) {double(:use_case_data, id: 0, opr_event_special_quest_puzzle_stage_id: 1, mst_puzzle_opponent_id: 2, level: 3, wave_number: 4)}

    it do
      view_model = subject
      expect(view_model.is_a?(OprEventSquestPstageOpponentViewModel)).to be_truthy
