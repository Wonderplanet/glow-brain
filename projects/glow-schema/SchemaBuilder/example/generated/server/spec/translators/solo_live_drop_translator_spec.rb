...
RSpec.describe "SoloLiveDropTranslator" do
  subject { SoloLiveDropTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(SoloLiveDropViewModel)).to be_truthy
