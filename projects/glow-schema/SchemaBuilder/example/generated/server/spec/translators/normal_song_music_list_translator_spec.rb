...
RSpec.describe "NormalSongMusicListTranslator" do
  subject { NormalSongMusicListTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(NormalSongMusicListViewModel)).to be_truthy
