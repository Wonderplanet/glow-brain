...
RSpec.describe "EpisodeTranslator" do
  subject { EpisodeTranslator.translate(use_case_data) }

  context do
    let(:use_case_data) {double(:use_case_data, id: 0, mst_episode_id: 1, play_count: 2, clear_count: 3)}

    it do
      view_model = subject
      expect(view_model.is_a?(EpisodeViewModel)).to be_truthy
