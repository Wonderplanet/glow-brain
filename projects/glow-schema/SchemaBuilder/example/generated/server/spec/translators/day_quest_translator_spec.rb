...
RSpec.describe "DayQuestTranslator" do
  subject { DayQuestTranslator.translate(use_case_data) }

  context do
    let(:use_case_data) {double(:use_case_data, id: 0, mst_day_quest_id: 1, play_count: 2, clear_count: 3)}

    it do
      view_model = subject
      expect(view_model.is_a?(DayQuestViewModel)).to be_truthy
