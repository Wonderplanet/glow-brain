...
RSpec.describe "DailyMissionRewardResultTranslator" do
  subject { DailyMissionRewardResultTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(DailyMissionRewardResultViewModel)).to be_truthy
