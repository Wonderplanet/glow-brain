...
RSpec.describe "MstDayQuestPuzzleStageTranslator" do
  subject { MstDayQuestPuzzleStageTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(MstDayQuestPuzzleStageViewModel)).to be_truthy
