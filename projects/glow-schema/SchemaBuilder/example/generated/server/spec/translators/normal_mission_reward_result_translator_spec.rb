...
RSpec.describe "NormalMissionRewardResultTranslator" do
  subject { NormalMissionRewardResultTranslator.translate(use_case_data) }
  ...
  context do
    ...
    it do
      view_model = subject
      expect(view_model.is_a?(NormalMissionRewardResultViewModel)).to be_truthy
