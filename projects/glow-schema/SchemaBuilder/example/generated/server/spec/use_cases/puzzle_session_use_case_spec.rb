...
RSpec.describe "PuzzleSessionUseCase" do
  let(:use_case) { PuzzleSessionUseCase.new }
  let(:user) { create(:user) }

  context "#guests" do
    subject { use_case.guests(user)  }
  ...
  context "#continue" do
    subject { use_case.continue(user)  }
