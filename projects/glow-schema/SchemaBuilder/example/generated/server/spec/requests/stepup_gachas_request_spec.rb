...
RSpec.describe "POST /api/stepup_gacha", type: :request do
  subject { post "/api/stepup_gacha", params: {} }
...
RSpec.describe "POST /api/stepup_gacha/prizes", type: :request do
  subject { post "/api/stepup_gacha/prizes", params: {} }
