...
RSpec.describe "GET /api/solo_live_musical_units/me", type: :request do
  subject { get "/api/solo_live_musical_units/me", params: {} }
...
RSpec.describe "PUT /api/solo_live_musical_units", type: :request do
  subject { put "/api/solo_live_musical_units", params: {} }
