...
RSpec.describe "POST /api/gacha", type: :request do
  subject { post "/api/gacha", params: {} }
...
RSpec.describe "POST /api/gacha/prizes", type: :request do
  subject { post "/api/gacha/prizes", params: {} }
