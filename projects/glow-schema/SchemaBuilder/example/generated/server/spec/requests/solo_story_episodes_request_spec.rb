...
RSpec.describe "POST /api/solo_story_episodes/:id/session", type: :request do
  subject { post "/api/solo_story_episodes/:id/session", params: {} }
...
RSpec.describe "DELETE /api/solo_story_episodes/session", type: :request do
  subject { delete "/api/solo_story_episodes/session", params: {} }
