...
RSpec.describe "POST /api/character_variant_graphics/release", type: :request do
  subject { post "/api/character_variant_graphics/release", params: {} }
...
RSpec.describe "POST /api/character_variant_graphics/change", type: :request do
  subject { post "/api/character_variant_graphics/change", params: {} }
