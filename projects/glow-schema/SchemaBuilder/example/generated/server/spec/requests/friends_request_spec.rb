...
RSpec.describe "GET /api/friends", type: :request do
  subject { get "/api/friends", params: {} }
...
RSpec.describe "DELETE /api/friends", type: :request do
  subject { delete "/api/friends", params: {} }
