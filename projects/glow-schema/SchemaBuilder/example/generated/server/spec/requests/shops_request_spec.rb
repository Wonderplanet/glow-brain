...
RSpec.describe "POST /api/shop/purchase", type: :request do
  subject { post "/api/shop/purchase", params: {} }
...
RSpec.describe "POST /api/shop/bulk_purchase", type: :request do
  subject { post "/api/shop/bulk_purchase", params: {} }
