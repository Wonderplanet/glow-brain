...
RSpec.describe "POST /api/mini_stories/release", type: :request do
  subject { post "/api/mini_stories/release", params: {} }
...
RSpec.describe "PATCH /api/mini_stories/play", type: :request do
  subject { patch "/api/mini_stories/play", params: {} }
