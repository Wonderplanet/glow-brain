        ...
        IUIPageViewControllerPageControlDataSource
    {
            ...
            MasterDataId presentationMstArtworkId)
        {
            ...
            foreach (var id in tempList)
            {
                ...
                controller.InitializeViewTransform();
                if (id == presentationMstArtworkId)
                {
                    controller.ActualView.IsFirstArtworkPage = true;
                }
        ...
        {
            _contentViewControllers[pageView.PageControl.CurrentPage].BeginAppearanceTransition(true, false);
        }
