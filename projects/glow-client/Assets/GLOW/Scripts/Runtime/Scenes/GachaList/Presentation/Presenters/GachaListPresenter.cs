...
namespace GLOW.Scenes.GachaList.Presentation.Presenters
{
        ...
        IGachaListContentViewDelegate
    {
        ...
        void IGachaListViewDelegate.OnViewWillAppear(MasterDataId initialShowOprGachaId)
        {
            ...
            else
            {
                ...
                InitializeView(initialShowOprGachaId);
            }
        }
        ...
        void IGachaListViewDelegate.ShowStepupGachaRatioDialogView(MasterDataId oprGachaId)
        {
            DoAsync.Invoke(ViewController.GetActualView, ScreenInteractionControl, async ct =>
            {
                var useCaseModel = await StepupGachaRatioDialogUseCase.GetStepupGachaRatioUseCaseModel(ct, oprGachaId);
                var viewModel = StepupGachaRatioDialogViewModelTranslator.TranslateToViewModel(useCaseModel, OnClickIconDetail);

                GachaWireFrame.ShowStepupGachaRatioDialogView(oprGachaId, viewModel, ViewController.GetViewController);
            });
        }
        ...
        void IGachaListViewDelegate.ShowGachaDetailDialogView(MasterDataId oprGachaId)
        {
            DoAsync.Invoke(ViewController.GetActualView, ScreenInteractionControl, async ct =>
            {
                ...
                GachaWireFrame.ShowGachaDetailView(viewModel, ViewController.GetViewController);
            });
        }
        ...
        {
            ShowGachaContentView(oprGachaId);
        }
        ...
        void ShowGachaContentView(MasterDataId oprGachaId)
        {
            ...
            GachaContentViewController.UpdateContentView(
                ...
                viewModel.StepUpGachaViewModel,
