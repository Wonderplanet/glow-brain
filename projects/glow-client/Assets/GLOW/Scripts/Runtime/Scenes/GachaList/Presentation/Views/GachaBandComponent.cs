...
namespace GLOW.Scenes.GachaList.Presentation.Views
{
    public class GachaBandComponent: UIObject
    {
        ...
        [Header("ステップアップ")]
        [SerializeField] UIImage _bandStepup;
        [SerializeField] UIText _bandStepupText;
        ...
        public void GachaContentBandSetup(GachaType type, GachaName gachaName)
        {
            ...
            _bandStepup.gameObject.SetActive(type == GachaType.Stepup);
            ...
            switch (type)
            {
                ...
                case GachaType.Stepup:
                    _bandStepupText.SetText(gachaName.Value);
                    break;
                default:
                    break;
            }
