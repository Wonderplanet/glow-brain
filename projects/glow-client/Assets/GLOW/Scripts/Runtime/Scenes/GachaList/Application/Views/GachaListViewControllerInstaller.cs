...
namespace GLOW.Scenes.GachaList.Application.Views
{
    public class GachaListViewControllerInstaller : Zenject.Installer
    {
        public override void InstallBindings()
        {
            ...
            Container.Bind<StepupGachaRatioDialogUseCase>().AsCached();
            ...
            Container.BindViewFactoryInfo<GachaHistoryDetailDialogViewController,
                GachaHistoryDetailDialogViewControllerInstaller>();
            Container.Bind<GachaHistoryWireFrame>().AsCached();
            Container.Bind<GachaHistoryDialogUseCase>().AsCached();
        }

        void InstallGachaContent()
        {
            ...
            Container.BindViewFactoryInfo<UnitSpecialAttackPreviewViewController,
                UnitSpecialAttackPreviewViewControllerInstaller>();
        }
