...
namespace GLOW.Scenes.GachaList.Domain.UseCases
{
    public class GachaListUseCase
    {
        ...
        [Inject] IGachaDisplayEvaluator GachaDisplayEvaluator { get; }
            ...
            IReadOnlyList<MasterDataId> sortedOprGachaModelIds)
        {
            ...
            if (gameFetchOtherModel.TutorialStatus.IsStartMainPart1())
            {
        ...
        IReadOnlyList<GachaListElementUseCaseModel> CreateGachaListUseCaseElementModels(
            IReadOnlyList<OprGachaModel> activeOprGachaModels)
        {
