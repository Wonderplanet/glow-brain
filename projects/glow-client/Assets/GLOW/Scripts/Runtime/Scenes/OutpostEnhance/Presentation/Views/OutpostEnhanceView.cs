...
namespace GLOW.Scenes.OutpostEnhance.Presentation.Views
{
    public class OutpostEnhanceView : UIView
    {
        ...
        [SerializeField] UIText _totalArtworkCount;
        [SerializeField] UIText _totalArtworkBonus;
        ...
        public void SetTotalArtworkCount(TotalArtworkCount count)
        {
            _totalArtworkCount.SetText(count.ToString());
        }

        public void SetTotalArtworkBonus(HP totalBonus)
        {
            _totalArtworkBonus.SetText("+{0}", totalBonus.ToString());
        }
