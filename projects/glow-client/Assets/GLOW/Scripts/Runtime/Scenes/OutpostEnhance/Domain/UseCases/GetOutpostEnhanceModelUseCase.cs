...
namespace GLOW.Scenes.OutpostEnhance.Domain.UseCases
{
    public class GetOutpostEnhanceModelUseCase
    {
        ...
        public OutpostEnhanceUseCaseModel GetOutpostEnhanceModel()
        {
            ...
            // 原画ボーナス分のHP
            var artworkBonusHp = GetTotalArtworkBonusHp();
            // 合計所持原画数
            var totalArtworkCount = new TotalArtworkCount(GameRepository.GetGameFetchOther().UserArtworkModels.Count);

            return new OutpostEnhanceUseCaseModel(
                userCoin,
                currentHp,
                artworkBonusHp,
                totalArtworkCount,
        ...
        HP GetCurrentHp()
        {
            ...
            // 原画ボーナス分のHP
            var artworkBonus = GetTotalArtworkBonusHp();
