...
namespace GLOW.Scenes.OutpostEnhance.Presentation.Views.Component
{
    public class OutpostEnhanceAnimationComponent : MonoBehaviour
    {
        ...
        [SerializeField] UIObject _totalArtworkCountRoot;
        [SerializeField] UIObject _totalArtworkBonusRoot;
        ...
        void Awake()
        {
            ...
            _totalArtworkCountRoot.IsVisible = true;
            _totalArtworkBonusRoot.IsVisible = true;
        }
        ...
        public async UniTask PlayEnhanceEffectAnimation(CancellationToken cancellationToken)
        {
            ...
            _totalArtworkBonusRoot.IsVisible = false;
            _totalArtworkCountRoot.IsVisible = false;
