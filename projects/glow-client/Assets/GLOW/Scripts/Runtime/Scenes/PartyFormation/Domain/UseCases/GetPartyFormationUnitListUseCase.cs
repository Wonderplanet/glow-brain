...
namespace GLOW.Scenes.PartyFormation.Domain.UseCases
{
    public class GetPartyFormationUnitListUseCase
    {
            ...
            InGameContentType inGameContentType)
        {
            ...
            var specialRuleUnitStatusModels = new List<MstInGameSpecialRuleUnitStatusModel>();
            if (inGameContentType == InGameContentType.Pvp)
            {
                specialRuleUnitStatusModels = GetInGameSpecialRuleUnitStatusModels(mstStageId, inGameContentType);
            }
