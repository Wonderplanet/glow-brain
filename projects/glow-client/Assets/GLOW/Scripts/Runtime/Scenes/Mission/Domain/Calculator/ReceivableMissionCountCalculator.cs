...
namespace GLOW.Scenes.Mission.Domain.Calculator
{
    public static class ReceivableMissionCountCalculator
    {
        ...
        public static int GetReceivableMissionOfArtworkPanelCount(
            ArtworkPanelMissionFetchResultModel artworkPanelMissionFetchResultModel)
        {
            var receivableMissionCount = artworkPanelMissionFetchResultModel
                .ArtworkPanelMissionListCellModels
                .Count(cell => cell.MissionStatus == MissionStatus.Receivable);
            return receivableMissionCount;
        }
    }
