...
namespace GLOW.Scenes.StaminaRecover.Presentation.StaminaTrade
{
    public class StaminaTradeView : UIView
    {
        ...
        public void Setup(StaminaTradeViewModel viewModel, Action updateAction)
        {
            ...
            SetConfirmText(viewModel.Name, _amountSelectionComponent.Amount.Value, viewModel.EffectValue);
        ...
        public void SetConfirmText(ItemName itemName, int selectedAmount, Stamina effectValue)
        {
            _confirmText.SetText(_confirmTextFormat, itemName.Value, selectedAmount, effectValue.Value);
        }
