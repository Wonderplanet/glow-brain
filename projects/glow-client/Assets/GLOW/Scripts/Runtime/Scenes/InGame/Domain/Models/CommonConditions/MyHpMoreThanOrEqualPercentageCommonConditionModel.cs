...
{
    public record MyHpMoreThanOrEqualPercentageCommonConditionModel(Percentage HpPercentage) : ICommonConditionModel
    {
        public InGameCommonConditionType ConditionType => InGameCommonConditionType.MyHpMoreThanOrEqualPercentage;
