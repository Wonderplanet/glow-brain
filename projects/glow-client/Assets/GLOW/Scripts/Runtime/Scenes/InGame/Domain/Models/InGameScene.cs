...
namespace GLOW.Scenes.InGame.Domain.Models
{
    public class InGameScene : IInGameScene
    {
        ...
        public ArtworkEffectModel ArtworkEffectModel { get; set; } = ArtworkEffectModel.Empty;
        public ArtworkEffectModel PvpOpponentArtworkEffectModel { get; set; } = ArtworkEffectModel.Empty;
