...
{
    public class CharacterUnitForceKnockBackAction : CharacterUnitKnockBackActionBase, ICharacterUnitAction
    {
        public UnitActionState ActionState => UnitActionState.ForceKnockBack;
        ...
        public CharacterUnitForceKnockBackAction(TickCount duration, float distance, ICharacterUnitAction prevAction)
        ...
        {
            return new CharacterUnitForceKnockBackAction(remainingDuration, remainingDistance, prevAction);
        }
    }
}
