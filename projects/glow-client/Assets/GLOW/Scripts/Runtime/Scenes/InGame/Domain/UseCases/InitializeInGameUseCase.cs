...
namespace GLOW.Scenes.InGame.Domain.UseCases
{
    public class InitializeInGameUseCase
    {
        ...
        [Inject] IArtworkEffectInitializer ArtworkEffectInitializer { get; }
        ...
        public InitializeResultModel Initialize()
        {
            ...
            // 原画効果の初期化
            var artworkEffectInitializationResult = ArtworkEffectInitializer.Initialize(selectedStage.InGameType);
            var artworkEffect = artworkEffectInitializationResult.ArtworkEffectModel;
            var pvpOpponentArtworkEffect = artworkEffectInitializationResult.PvpOpponentArtworkEffectModel;
            InGameScene.ArtworkEffectModel = artworkEffect;
            InGameScene.PvpOpponentArtworkEffectModel = pvpOpponentArtworkEffect;
            ...
            // デッキの初期化
            var deckInitializerResult = DeckInitializer.Initialize(
                outpostEnhancement,
