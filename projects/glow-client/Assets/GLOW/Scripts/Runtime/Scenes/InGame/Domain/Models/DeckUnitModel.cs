...
namespace GLOW.Scenes.InGame.Domain.Models
{
    public record DeckUnitModel(
        ...
        PercentageM ArtworkEffectHpBonus,
        PercentageM ArtworkEffectAttackPowerBonus,
        TickCount ArtworkEffectSpecialAttackCoolTimeBonus,
        TickCount ArtworkEffectSummonCoolTimeBonus,
