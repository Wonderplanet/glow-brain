...
namespace GLOW.Scenes.InGame.Presentation.Presenters
{
        ...
        , ITutorialInGameViewDelegate
    {
        ...
        StaminaRecoverSelectViewController _staminaRecoverSelectViewController;
        ...
        {
            if(_staminaRecoverSelectViewController != null)
            {
                // 既に表示中の場合は何もしない
                return;
            }
            ...
            var controller =
                ViewFactory
                    .Create<StaminaRecoverSelectViewController, StaminaRecoverSelectViewController.Argument>(
                        new StaminaRecoverSelectViewController.Argument(StaminaRecoverSelectType.Lack));
            _staminaRecoverSelectViewController = controller;

            controller.OnDismissAction = () =>
            {
                _staminaRecoverSelectViewController = null;
