...
namespace GLOW.Scenes.InGame.Domain.Extensions
{
    public static class AttackHitTypeExtension
    {
        ...
        public static bool IsBlockableHitTypeByUnbeatable(this AttackHitType attackHitType)
        {
            return attackHitType switch
            {
                AttackHitType.Stun or 
                AttackHitType.Freeze or 
                AttackHitType.KnockBack1 or
                AttackHitType.KnockBack2 or
                AttackHitType.KnockBack3 => true,
