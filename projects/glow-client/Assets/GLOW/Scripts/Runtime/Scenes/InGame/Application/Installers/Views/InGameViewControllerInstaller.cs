...
namespace GLOW.Scenes.InGame.Application.Installers
{
    public class InGameViewControllerInstaller : Installer
    {
        public override void InstallBindings()
        {
            ...
            Container.BindInterfacesTo<ArtworkEffectModelFactory>().AsCached();
            ...
            Container.BindInterfacesTo<ArtworkEffectInitializer>().AsCached();
            ...
            Container.BindInterfacesTo<ArtworkEffectActivationEvaluator>().AsCached();
            Container.BindInterfacesTo<ArtworkEffectTargetEvaluator>().AsCached();
        ...
        void InstallDebugBindings()
        {
            ...
            Container.Bind<DebugGetSkillOperationUnitInfosUseCase>().AsCached();
            Container.Bind<DebugApplySpecialAttackTemplateUseCase>().AsCached();
            Container.Bind<DebugSaveSpecialAttackTemplateUseCase>().AsCached();
