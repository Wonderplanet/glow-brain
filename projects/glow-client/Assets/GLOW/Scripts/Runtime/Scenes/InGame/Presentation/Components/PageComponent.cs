...
namespace GLOW.Scenes.InGame.Presentation.Components
{
    ...
    public class PageComponent : UIObject
    {
        ...
        public AbstractMangaEffectComponent GenerateMangaEffect(
            GameObject prefab, 
            FieldViewCoordV2 pos, 
            FieldObjectId fieldObjectId, 
            bool isFlip)
        {
            return _mangaEffectLayer.Generate(prefab, pos, fieldObjectId, isFlip);
        }
        ...
        {
            _mangaEffectLayer.PauseWithout(handler, withoutFieldObjectId);
            _effectLayer.PauseAllEffects(handler);
            _damageDisplayLayer.PauseAllEffects(handler);
