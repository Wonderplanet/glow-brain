...
namespace GLOW.Scenes.InGame.Presentation.Components
{
    ...
    public class RushButton : UIObject
    {
        ...
        [SerializeField] RushChargeCoolTimeBonusIcon _rushChargeCoolTimeBonusIcon;
        ...
        public void Initialize(RushModel rushModel)
        {
            ...
            _rushPowerUpIcon.Initialize(rushModel.ArtworkEffectPowerUpBonus);
            _rushChargeCoolTimeBonusIcon.Initialize(rushModel.ArtworkEffectChargeSpeedUpBonus);
