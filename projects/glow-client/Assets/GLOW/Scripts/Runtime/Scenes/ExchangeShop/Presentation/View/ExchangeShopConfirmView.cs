...
namespace GLOW.Scenes.ExchangeShop.Presentation.View
{
    public class ExchangeShopConfirmView : UIView
    {
        ...
        [Header("交換アイテム")]
        [SerializeField] PlayerResourceIconComponent _tradeItemIcon;
        ...
        public void Setup(
            ...
            PlayerResourceIconViewModel exchangeIconViewModel,
            Action onChangeSelectAmount)
        {
            ...
            SetUpTradeItemIcon(exchangeIconViewModel);
        ...
        public void SetUpTradeItemIcon(PlayerResourceIconViewModel iconViewModel)
        {
            _tradeItemIcon.Setup(iconViewModel);
        }
