...
namespace GLOW.Scenes.ExchangeShop.Presentation.View
{
    public class ExchangeShopConfirmViewController : UIViewController<ExchangeShopConfirmView>
    {
        ...
        {
            var tradeItemAmount = _exchangeConfirmViewModel.ExchangeItemAmount.Value * ActualView.SelectedTradeAmount.Value;
            var itemIconViewModel = _tradeIconViewModel with
            {
                Amount = new PlayerResourceAmount(tradeItemAmount)
            };
