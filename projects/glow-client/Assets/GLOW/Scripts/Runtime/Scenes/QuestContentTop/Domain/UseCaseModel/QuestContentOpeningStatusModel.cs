...
namespace GLOW.Scenes.QuestContentTop.Domain.UseCaseModel
{
        ...
        QuestContentReleaseRequiredSentence QuestContentReleaseRequiredSentence)
    {
        ...
        {
            return OpeningStatusAtUserStatus == QuestContentOpeningStatusAtUserStatus.StageLocked ||
                   OpeningStatusAtUserStatus == QuestContentOpeningStatusAtUserStatus.RankLocked;
        }
    }
}
