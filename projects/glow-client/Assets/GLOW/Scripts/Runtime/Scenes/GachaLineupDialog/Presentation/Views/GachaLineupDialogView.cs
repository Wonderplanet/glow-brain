...
using GLOW.Scenes.GachaLineupDialog.Presentation.Views.Components;
...
namespace GLOW.Scenes.GachaLineupDialog.Presentation.Views
{
    ...
    /// </summary>
    public class GachaLineupDialogView : UIView
    {
        [SerializeField] GachaLineupPageRootComponent _gachaRatioPageRootComponent;
        [SerializeField] UIToggleableComponentGroup _tabButtonGroup;
        [SerializeField] UIObject _fixedPrizeTabButton;
        ...
        void SetupTabButtonGroup(GachaLineupDialogViewModel viewModel)
        {
            ...
            _fixedPrizeTabButton.Hidden = viewModel.SSRRatioPageViewModel.IsEmpty();
