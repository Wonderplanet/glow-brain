...
namespace GLOW.Scenes.MainQuestTop.Presentation
{
    public class MainQuestTopPresenter : IMainQuestTopViewDelegate, IHomeMainStageSelectViewDelegate
    {
        ...
        [Inject] IReleaseHardTutorialContext ReleaseHardTutorialContext { get; }
        ...
        async UniTask IMainQuestTopViewDelegate.DoIfTutorial()
        {
            await ReleaseHardTutorialContext.DoIfTutorial(() => UniTask.CompletedTask);
        }
