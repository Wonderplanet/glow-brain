...
namespace GLOW.Scenes.Home.Presentation.Presenters
{
        ...
        ITutorialHomeViewDelegate
    {
        ...
        void IHomeHeaderDelegate.OnStaminaRecoverButton()
        {
            ...
            if (userParameterModel.MaxStamina.Value <= userParameterModel.Stamina.Value)
            {
            ...
            var argument = new StaminaRecoverSelectViewController.Argument(StaminaRecoverSelectType.Buy);
            var controller = ViewFactory
                .Create<StaminaRecoverSelectViewController, StaminaRecoverSelectViewController.Argument>(argument);
