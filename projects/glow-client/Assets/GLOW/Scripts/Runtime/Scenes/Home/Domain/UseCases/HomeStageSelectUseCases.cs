...
namespace GLOW.Scenes.Home.Domain.UseCases
{
    public class HomeStageSelectUseCases
    {
        ...
        public void UpdateCurrentMstQuestId(MasterDataId mstQuestId)
        {
            PreferenceRepository.SetCurrentHomeTopSelectMstQuestId(mstQuestId);
        }

        public MasterDataId GetInitialSelectMstStageId()
        {
            ...
            return GetInitialSelectMstStageId(shouldShowAnimation, stages, selectedMstStage);
        }
        ...
        DisplayTryStageTextFlag ShouldDisplayTryStageText()
        {
            ...
            var isDisplayTryStageText = isOnlyTutorialStage;
