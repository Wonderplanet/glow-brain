...
namespace GLOW.Scenes.Home.Presentation.Views
{
    public class HomeMainQuestView : UIView
    {
        ...
        [SerializeField] CanvasGroup _questLoadImageCanvasGroup;
        ...
        public CanvasGroup QuestLoadImageCanvasGroup => _questLoadImageCanvasGroup;
        ...
        {
            _campaignBalloonMultiSwitcherComponent.Hidden = !isActive;
        }
    }
}
