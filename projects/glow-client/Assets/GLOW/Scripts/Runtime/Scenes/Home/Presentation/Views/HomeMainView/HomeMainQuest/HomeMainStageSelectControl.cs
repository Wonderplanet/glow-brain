...
namespace GLOW.Scenes.Home.Presentation.Views
{
    ...
    public interface IHomeMainStageSelectViewDelegate
    {
        void OnQuestInfoClicked(MasterDataId stageId);
        void OnQuestUnReleasedClicked(StageReleaseRequireSentence releaseRequireSentence);
    }

    public class HomeMainStageSelectControl :
        ...
        IGlowCustomCarouselViewDelegate
    {
        ...
        readonly IHomeMainStageSelectViewDelegate _viewDelegate;
        ...
        public HomeMainStageSelectControl(
            ...
            IHomeMainStageSelectViewDelegate viewDelegate)
        {
            _view = view;
