...
using GLOW.Scenes.ArtworkEnhance.Application;
...
using GLOW.Scenes.ArtworkPanelMission.Application.Installers;
...
using GLOW.Scenes.ArtworkPanelMission.Presentation.WireFrame;
...
using GLOW.Scenes.BoxGacha.Application.Installers;
...
using GLOW.Scenes.HomeMainKomaSetting.Application;
using GLOW.Scenes.HomeMainKomaSettingFilter.Application;
using GLOW.Scenes.HomeMainKomaSettingFilter.Presentation;
using GLOW.Scenes.HomeMainKomaSettingItem.Application;
...
using GLOW.Scenes.QuestSelectList.Application;
...
using GLOW.Scenes.StepupGachaRatioDialog.Application.Installers;
...
namespace GLOW.Scenes.Home.Applications.Installers.Views
{
    public class HomeViewControllerInstaller : Installer
    {
        public override void InstallBindings()
        {
            ...
            InstallWebstorePurchase();
            InstallEvent();
            InstallPvp();
            InstallTradeShop();
            InstallBoxGacha();
            InstallArtworkPanelMission();
            ...
            Container.BindViewFactoryInfo<HomePartyTabViewController, HomePartyTabViewControllerInstaller>();
            Container.BindViewFactoryInfo<ArtworkFormationViewController, ArtworkFormationViewControllerInstaller>();
            ...
            Container.BindViewFactoryInfo<QuestSelectListViewController, QuestSelectListViewInstaller>();
            Container.BindViewFactoryInfo<MainQuestTopViewController, MainQuestTopViewInstaller>();
            ...
            Container.BindViewFactoryInfo<
                StaminaDiamondRecoverConfirmViewController,
                StaminaDiamondRecoverConfirmViewControllerInstaller>();
            ...
            Container.BindViewFactoryInfo<ArtworkEnhanceViewController,
                ArtworkEnhanceViewControllerInstaller>();
            Container.BindViewFactoryInfo<ArtworkGradeUpConfirmViewController,
                ArtworkUpGradeConfirmViewControllerInstaller>();
            Container.BindViewFactoryInfo<ArtworkAcquisitionRouteViewController,
                ArtworkAcquisitionRouteViewControllerInstaller>();
            Container.BindViewFactoryInfo<ArtworkGradeContentsViewController,
                ArtworkGradeContentsViewControllerInstaller>();
            Container.BindViewFactoryInfo<ArtworkGradeUpAnimViewController,
                ArtworkGradeUpAnimViewControllerInstaller>();
            ...
            Container.Bind<ApplyArtworkFormationUseCase>().AsCached();
            ...
            Container.BindInterfacesTo<ContentNoticePvpFactory>().AsCached();
            ...
            Container.Bind<GetLatestEventInfoUseCase>().AsCached();
            ...
            Container.Bind<GetArtworkSortAndFilterUseCase>().AsCached();
        ...
        void InstallUtil()
        {
            ...
            Container.BindInterfacesTo<GachaContentAssetLoader>().AsCached();
            Container.BindInterfacesTo<EventTopBackGroundLoader>().AsCached();
            Container.BindInterfacesTo<HomeMainKomaPatternLoader>().AsCached();
        ...
        void InstallHomeMain()
        {
            ...
            // HomeMainコマ設定
            Container.BindViewFactoryInfo<HomeMainKomaSettingViewController, HomeMainKomaSettingViewInstaller>();
            Container.BindViewFactoryInfo<HomeMainKomaSettingItemViewController, HomeMainKomaSettingItemViewInstaller>();
            Container.BindViewFactoryInfo<HomeMainKomaSettingUnitSelectViewController, HomeMainKomaSettingUnitSelectViewInstaller>();
            Container.BindViewFactoryInfo<HomeMainKomaSettingFilterViewController, HomeMainKomaSettingFilterViewInstaller>();
            Container.Bind<HomeMainKomaSettingWireFrame>().AsCached();

            Container.Bind<HomeMainKomaUseCase>().AsCached();
            Container.BindInterfacesTo<HomeMainKomaSettingUserRepository>().AsCached();
            //ここ以外ではBindしないこと(内部のCache更新が、片方のBindインスタンスにしか適用されないため)
            Container.BindInterfacesTo<UserHomeKomaSettingDataLocalDataStore>().AsSingle();
        }
        ...
        void InstallBoxGacha()
        {
            Container.BindViewFactoryInfo<BoxGachaTopViewController, BoxGachaTopViewControllerInstaller>();
            Container.BindViewFactoryInfo<BoxGachaResultViewController, BoxGachaResultViewControllerInstaller>();
            Container.BindInterfacesTo<BoxGachaService>().AsCached();
            Container.BindInterfacesTo<UserBoxGachaCacheRepository>().AsCached();
            Container.BindInterfacesTo<BoxGachaInfoModelFactory>().AsCached();
            Container.BindInterfacesTo<MstBoxGachaProvider>().AsCached();
            Container.BindInterfacesTo<BoxGachaDrawableEvaluator>().AsCached();
            Container.Bind<FetchBoxGachaInfoUseCase>().AsCached();
        }

        void InstallArtworkPanelMission()
        {
            Container.BindViewFactoryInfo<ArtworkPanelMissionViewController, ArtworkPanelMissionViewControllerInstaller>();
            Container.Bind<ShowArtworkPanelMissionListUseCase>().AsCached();
            Container.BindInterfacesTo<ArtworkPanelMissionResultModelFactory>().AsCached();
            Container.BindInterfacesTo<ArtworkPanelMissionInfoModelFactory>().AsCached();
            Container.BindInterfacesTo<ArtworkPanelMissionReceivedRewardApplier>().AsCached();
            Container.BindInterfacesTo<ArtworkPanelMissionReceivedStatusApplier>().AsCached();
            Container.BindInterfacesTo<ArtworkPanelMissionExistEvaluator>().AsCached();
            Container.BindInterfacesTo<MissionOfArtworkPanelRepository>().AsCached();
            Container.BindInterfacesTo<ArtworkPanelMissionWireFrame>().AsCached();
        }
        ...
        void InstallNavigator()
        {
            ...
            Container.BindInterfacesTo<StepUpGachaContentUseCaseModelFactory>().AsCached();
            ...
            Container.Bind<PvpStatusUseCase>().AsCached();
        ...
        void InstallHelpers()
        {
            ...
            Container.BindInterfacesTo<ArtworkListFilterAndSort>().AsCached();
        }
        ...
        void InstallGacha()
        {
            ...
            Container.BindInterfacesTo<GachaDisplayEvaluator>().AsCached();
            ...
            Container.BindViewFactoryInfo<StepupGachaRatioDialogViewController, StepupGachaRatioDialogViewControllerInstaller>();
        ...
        void InstallTutorial()
        {
            ...
            Container.Bind<TutorialGachaConfirmedApplyUseCase>().AsCached();
        ...
        void InstallWebstorePurchase()
        {
            Container.Bind<WebstorePurchaseProductUseCase>().AsCached();
        }
