...
namespace GLOW.Scenes.AdventBattle.Presentation.Presenter
{
    public class AdventBattleWireFrame
    {
        ...
        public void ShowPartyFormationView(HomePartyTabViewController.Argument argument)
        {
            var controller = ViewFactory.Create<HomePartyTabViewController, HomePartyTabViewController.Argument>(argument);
            HomeViewNavigation.TryPush(controller, HomeContentDisplayType.BottomOverlap);
        }
