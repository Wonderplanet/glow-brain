...
namespace GLOW.Scenes.BoxGachaResult.Presentation.Component
{
    public class BoxGachaResultComponent : UIObject
    {
        ...
        [SerializeField] BoxGachaConvertTextComponent _boxGachaConvertTextComponent;
        ...
        {
            _boxGachaConvertTextComponent.IsVisible = false;
            // アバター獲得テキストを表示する
        ...
        {
            _boxGachaConvertTextComponent.SetUpConvertText(convertedResourceTypes);
        }
        ...
        void PlayConvertAnimation(
            ...
            PreConversionResourceExistenceFlag existsPreConversionResource)
        {
            _boxGachaConvertTextComponent.IsVisible = existsPreConversionResource;
