...
namespace GLOW.Scenes.GachaWireFrame.Presentation.Presenters
{
    ...
    public interface IGachaTransitionFromShopControl
    {
        ...
        void ShowGachaLineUpDialogView(
            MasterDataId oprGachaId,
            GachaLineupDialogViewModel viewModel,
            UIViewController parentViewController);

        void ShowStepupGachaRatioDialogView(
            MasterDataId oprGachaId,
            StepupGachaRatioDialogViewModel viewModel,
            UIViewController parentViewController);
    ...
    public class GachaWireFrame : IGachaTransitionFromShopControl
    {
        ...
        StepupGachaRatioDialogViewController _stepupGachaRatioDialogViewController;
        ...
        UnitDetailOpenType UnitDetailOpenType
        {
            get
            {
                ...
                else if (_stepupGachaRatioDialogViewController != null)
                {
                    return UnitDetailOpenType.StepupRatio;
                }
                else
                {
        ...
        void IGachaTransitionFromShopControl.ShowGachaRatioDialogView(
            ...
            UIViewController parentViewController)
        {
            ShowGachaRatioDialogView(oprGachaId, viewModel, parentViewController);
        }
        ...
        public void ShowGachaRatioDialogView(
            ...
            UIViewController parentViewController)
        {
            var argument = new GachaRatioDialogViewController.Argument(oprGachaId, viewModel);
        ...
        public void ShowGachaLineUpDialogView(
            ...
            UIViewController parentViewController)
        {
            var argument = new GachaLineupDialogViewController.Argument(oprGachaId, viewModel);
        ...
        public void ShowStepupGachaRatioDialogView(
            MasterDataId oprGachaId,
            StepupGachaRatioDialogViewModel viewModel,
            UIViewController parentViewController)
        {
            var argument = new StepupGachaRatioDialogViewController.Argument(oprGachaId, viewModel);
            _stepupGachaRatioDialogViewController = CreateStepupGachaRatioDialogViewController(argument);
            parentViewController.PresentModally(_stepupGachaRatioDialogViewController);
        }

        public void OnCloseStepupGachaRatioDialogViewAndInvokeAction()
        {
            if (_stepupGachaRatioDialogViewController == null) return;

            _stepupGachaRatioDialogViewController?.Dismiss();
            _stepupGachaRatioDialogViewController = null;
        }

        void IGachaTransitionFromShopControl.OnClickIconDetail(
        ...
        void OnUnitDetailView(MasterDataId mstUnitId, UIViewController parentViewController)
        {
            if(UnitDetailOpenType == UnitDetailOpenType.Ratio)
            {
                ShowUnitDetailViewFromRatio(mstUnitId, parentViewController);
            }
            else if (UnitDetailOpenType == UnitDetailOpenType.LineUp)
            {
                ShowUnitDetailViewFromLineUp(mstUnitId, parentViewController);
            }
            else if (UnitDetailOpenType == UnitDetailOpenType.StepupRatio)
            {
                ShowUnitDetailViewFromStepupRatio(mstUnitId, parentViewController);
            }
        }

        void ShowUnitDetailViewFromRatio(MasterDataId mstUnitId, UIViewController parentViewController)
        {
            ...
            var argument = new UnitDetailModalViewController.Argument(mstUnitId, MaxStatusFlag.True);
        ...
        void ShowUnitDetailViewFromLineUp(MasterDataId mstUnitId, UIViewController parentViewController)
        {
        ...
        void ShowUnitDetailViewFromStepupRatio(MasterDataId mstUnitId, UIViewController parentViewController)
        {
            var vcArgument = _stepupGachaRatioDialogViewController.Args;
            var normalizedPos = _stepupGachaRatioDialogViewController.NormalizedPos;
            var currentStepNumber = _stepupGachaRatioDialogViewController.CurrentStepNumber;
            var isNormalPrizeTabSelected = _stepupGachaRatioDialogViewController.IsNormalPrizeTabSelected;
            ...
            controller.OnClose = () => OnCloseUnitDetailViewFromStepupRatio(
                vcArgument,
                normalizedPos,
                currentStepNumber,
                isNormalPrizeTabSelected,
                parentViewController);
            OnCloseStepupGachaRatioDialogView();

            RootViewController.PresentModally(controller);
        }

        void OnCloseUnitDetailViewFromStepupRatio(
            StepupGachaRatioDialogViewController.Argument vcArgument,
            float normalizedPos,
            StepUpGachaStepNumber currentStepNumber,
            bool isNormalPrizeTabSelected,
            UIViewController parentViewController)
        {
            // 閉じる際に画面を移動していた場合は再表示しない
            var currentContentTypeAfterClose = HomeViewController.ViewContextController.CurrentContentType;
            ...
            _stepupGachaRatioDialogViewController = CreateStepupGachaRatioDialogViewController(vcArgument);

            parentViewController?.PresentModally(_stepupGachaRatioDialogViewController, false);

            var stepViewModel = vcArgument.ViewModel.StepViewModels
                .FirstOrDefault(step => step.StepNumber == currentStepNumber);
            if (stepViewModel != null)
            {
                _stepupGachaRatioDialogViewController.StepRatioPageSetUp(stepViewModel);
                _stepupGachaRatioDialogViewController.SwitchPrizeTypeTab(isNormalPrizeTabSelected);
            }

            _stepupGachaRatioDialogViewController.MoveScrollToTargetPos(normalizedPos);
        }

        void OnCloseStepupGachaRatioDialogView()
        {
            if (_stepupGachaRatioDialogViewController == null) return;
        ...
        StepupGachaRatioDialogViewController CreateStepupGachaRatioDialogViewController(
            StepupGachaRatioDialogViewController.Argument argument)
        {
            return ViewFactory.Create<
                StepupGachaRatioDialogViewController,
                StepupGachaRatioDialogViewController.Argument>(argument);
        }
