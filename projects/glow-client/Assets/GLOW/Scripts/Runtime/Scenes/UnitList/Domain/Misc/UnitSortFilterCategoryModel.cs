        ...
        public bool EqualsSpecialAttack(AttackData attackData)
        {
            ...
            foreach (var filterSpecialAttack in FilterSpecialAttackModel.SpecialAttacks)
            {
                bool isMatch = filterSpecialAttack switch
                {
                    ...
                    FilterSpecialAttack.RemoveBuff =>
                        HasStateEffectType(attackData, StateEffectType.RemoveBuff),
                    FilterSpecialAttack.RemoveDebuff =>
                        HasStateEffectType(attackData, StateEffectType.RemoveDebuff),
                    FilterSpecialAttack.Unbeatable =>
                        HasStateEffectType(attackData, StateEffectType.Unbeatable),
                    _ => false
                };
