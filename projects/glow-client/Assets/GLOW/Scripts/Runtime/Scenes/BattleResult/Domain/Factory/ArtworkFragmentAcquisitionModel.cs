...
namespace GLOW.Scenes.BattleResult.Domain.Factory
{
    public class ArtworkFragmentAcquisitionModelFactory : IArtworkFragmentAcquisitionModelFactory
    {
        ...
        ArtworkFragmentAcquisitionModel IArtworkFragmentAcquisitionModelFactory.
            CreateArtworkFragmentAcquisitionModelFromExchangeResultModel(
        ...
        {
            var artwork = MstArtworkDataRepository.GetArtwork(exchangeRewardModel.ExchangeReward.ResourceId);
            var mstArtworkId = artwork.Id;

            // 既に完成済みの原画の場合は演出をさせない
            var isAlreadyCompleted = beforeUserArtworkFragments
            ...
            var userArtworkFragmentData = beforeUserArtworkFragments
            ...
            var isCompleted =
                new ArtworkCompleteFlag(
                    exchangeTradeResultModel.UserArtworks.Any(d => d.MstArtworkId == mstArtworkId));
