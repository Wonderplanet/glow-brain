...
{
    public class BoxGachaTopViewController : UIViewController<BoxGachaTopView>, IEscapeResponder, IAsyncActivityControl
    {
        ...
        public void SetUpBoxGachaName(BoxGachaName boxGachaName)
        {
            ActualView.SetUpBoxGachaName(boxGachaName);
        }
