...
namespace GLOW.Scenes.BoxGacha.Presentation.View
{
    public class BoxGachaTopView : UIView
    {
        ...
        public void SetUpBoxGachaName(BoxGachaName gachaName)
        {
            _titleText.SetText(gachaName.Value);
        }

        public void SetUpCurrentBoxInfoText(BoxResetCount boxResetCount)
        {
            _currentBoxLevelText.SetText(ZString.Format("現在：{0}個目", boxResetCount.ToCurrentBoxNumber()));
        }
