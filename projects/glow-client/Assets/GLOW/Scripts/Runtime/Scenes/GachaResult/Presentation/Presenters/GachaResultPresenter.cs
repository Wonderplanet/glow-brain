...
namespace GLOW.Scenes.GachaResult.Presentation.Presenters
{
    ...
    public class GachaResultPresenter : IGachaResultViewDelegate
    {
        ...
        public void OnViewDidLoad()
        {
            ...
            ViewController.GachaDrawFromContentViewFlag = useCaseModel.GachaDrawFromContentViewFlag;
            
            _isInAppReviewDisplay = useCaseModel.IsAppReviewDisplay;

            // ガシャトップから引いた場合、ガシャトップに更新をかける
            if (useCaseModel.GachaDrawFromContentViewFlag)
            {
                GachaDrawControl.UpdateContentView();
            }
        ...
        void IGachaResultViewDelegate.OnReDrawButtonTapped(MasterDataId gachaId, GachaDrawType gachaDrawType)
        {
            ...
            controller.IsGachaDrawFromContentView = ViewController.GachaDrawFromContentViewFlag;
        ...
        {
            GachaDrawControl.TutorialGachaDraw(true);
        }
