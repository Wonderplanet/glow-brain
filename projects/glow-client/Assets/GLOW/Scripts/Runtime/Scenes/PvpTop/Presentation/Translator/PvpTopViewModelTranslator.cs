    ...
    public static class PvpTopViewModelTranslator
    {
        public static PvpTopViewModel Translate(PvpTopUseCaseModel model)
        {
            ...
            return new PvpTopViewModel(
                ...
                MstPvpExchangeShopId: model.MstPvpExchangeShopId,
            ...
            PvpTopOpponentModel opponentSelectStatusModel)
        {
            return new PvpTopOpponentViewModel(
                ...
                PartyArtworks: opponentSelectStatusModel.PartyArtworks.Select(TranslatePartyArtwork).ToList(),
        ...
        static PvpOpponentArtworkPartyViewModel TranslatePartyArtwork(PvpTopOpponentPartyArtworkModel partyArtwork)
        {
            return new PvpOpponentArtworkPartyViewModel(
                partyArtwork.ArtworkAssetPath,
                partyArtwork.Rarity,
                partyArtwork.Grade);
        }
