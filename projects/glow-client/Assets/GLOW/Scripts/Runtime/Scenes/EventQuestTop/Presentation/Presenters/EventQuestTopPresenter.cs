...
namespace GLOW.Scenes.EventQuestTop.Presentation.Presenters
{
    ...
    public class EventQuestTopPresenter : IEventQuestTopViewDelegate
    {
        ...
        void UpdateEventQuestTopBadge()
        {
            var badgeModel = EventQuestBadgeUseCase.GetEventQuestSelectBadge(_mstEventId);
            var badgeViewModel = EventQuestSelectBadgeViewModelTranslator.ToViewModel(badgeModel);
            ViewController.SetMissionBadge(badgeViewModel.IsExistReceivableMission);
            ViewController.SetBoxGachaBadge(badgeViewModel.IsBoxGachaDrawable);
        }
        ...
        void IEventQuestTopViewDelegate.OnMissionButtonTapped()
        {
            ...
            EventMissionWireFrame.ShowEventMissionViewInEvent(ViewController, _mstEventId, UpdateEventQuestTopBadge);
        }
        ...
        void IEventQuestTopViewDelegate.OnBoxGachaButtonTapped()
        {
            if (!EventOpenCheckUseCase.IsOpenEvent(_mstEventId))
            {
                EventQuestWireFrame.BackToHomeTop();
            ...
            DoAsync.Invoke(ViewController.ActualView, ScreenInteractionControl, async cancellationToken =>
            {
                ...
                var argument = new BoxGachaTopViewController.Argument(viewModel, _mstEventId);
