...
namespace GLOW.Scenes.GachaAnim.Presentation.Translator
{
    public class GachaAnimTranslator
    {
        ...
        public static GachaAnimResultViewModel ToTranslateGachaAnimResultViewModel(
            GachaAnimResultModel model,
            IPlayerResourceModelFactory playerResourceModelFactory)
        {
            ...
            return new GachaAnimResultViewModel(
                ...
                UnitImageGetStandAssetPath.FromAssetKey(model.UnitModel.UnitAssetKey),
                UnitImageGetAttackAssetPath.FromAssetKey(model.UnitModel.UnitAssetKey),
        ...
        public static GachaAnimStartViewModel ToTranslateGachaAnimStartViewModel(
            Rarity startRarity,
            Rarity endRarity,
            List<GachaAnimIconInfo> iconCellInfos)
        {
