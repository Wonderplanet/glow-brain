    ...
    public class GachaAnimPresenter : IGachaAnimViewDelegate
    {
        ...
        public void OnViewDidLoad()
        {
            ...
            foreach (var model in useCaseModel.GachaAnimResultModels)
            {
                ...
                var cellInfo = GachaAnimIconInfo.CreateGachaAnimIconInfo(
                    model.DisplayRarity,
                    model.ResourceType);
                iconCellInfos.Add(cellInfo);
            ...
            var startViewModel = GachaAnimTranslator.ToTranslateGachaAnimStartViewModel(
                useCaseModel.GachaAnimStartRarity,
                useCaseModel.GachaAnimEndRarity,
                iconCellInfos);
