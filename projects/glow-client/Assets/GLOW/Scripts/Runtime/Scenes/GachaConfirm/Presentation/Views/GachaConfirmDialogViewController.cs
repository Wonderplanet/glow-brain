...
namespace GLOW.Scenes.GachaConfirm.Presentation.Views
{
    ...
    public class GachaConfirmDialogViewController : UIViewController<GachaConfirmDialogView>, IEscapeResponder
    {
        ...
        bool _isReDraw;
        GachaDrawFromContentViewFlag _isGachaDrawFromContentView = GachaDrawFromContentViewFlag.False;
        ...
        public GachaDrawFromContentViewFlag IsGachaDrawFromContentView
        {
            set => _isGachaDrawFromContentView = value;
        }
