...
namespace GLOW.Scenes.EventQuestSelect.Presentation
{
    ...
    public class EventQuestSelectView : UIView
    {
        ...
        [Header("原画パネルミッション")]
        [SerializeField] UIObject _artworkPanelMissionButtonObj;
        [SerializeField] UIObject _artworkPanelMissionBadgeObj;
        [Header("降臨バトル")]
        ...
        [Header("いいジャンくじボタン")]
        [SerializeField] UIObject _boxGachaButtonNotificationBadge;
        [SerializeField] UIObject _boxGachaButtonObject;
        ...
        public void SetArtworkPanelMissionButtonActive(ArtworkPanelMissionExistFlag isExistArtworkPanelMission)
        {
            _artworkPanelMissionButtonObj.IsVisible = isExistArtworkPanelMission;
        }
        
        public void SetArtworkPanelMissionBadgeActive(bool visible)
        {
            _artworkPanelMissionBadgeObj.IsVisible = visible;
        }
        ...
        public void SetBoxGachaButtonVisible(MasterDataId mstBoxGachaId)
        {
            _boxGachaButtonObject.IsVisible = !mstBoxGachaId.IsEmpty();
        }
        
        public void SetBoxGachaNotificationBadgeVisible(BoxGachaDrawableFlag isBoxGachaDrawable)
        {
            _boxGachaButtonNotificationBadge.IsVisible = isBoxGachaDrawable;
        }
    }
}
