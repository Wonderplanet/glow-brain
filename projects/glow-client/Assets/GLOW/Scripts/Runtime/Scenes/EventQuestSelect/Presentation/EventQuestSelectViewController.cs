...
namespace GLOW.Scenes.EventQuestSelect.Presentation
{
        ...
        IEscapeResponder
    {
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            ViewDelegate.UpdateEventQuestSelectBadge();
        }
        ...
        public void SetEventQuestSelectBadge(EventQuestSelectBadgeViewModel viewModel)
        {
            ActualView.SetMissionBadgeActive(viewModel.IsExistReceivableMission);
            ActualView.SetArtworkPanelMissionBadgeActive(viewModel.IsExistReceivableArtworkPanelMission);
            ActualView.SetBoxGachaNotificationBadgeVisible(viewModel.IsBoxGachaDrawable);
        }
        ...
        public void SetUpView(EventQuestSelectViewModel viewModel)
        {
            ...
            DoAsync.Invoke(ActualView.GetCancellationTokenOnDestroy(), async ct =>
            {
                ...
                ActualView.SetBoxGachaButtonVisible(viewModel.MstBoxGachaId);
                ActualView.SetArtworkPanelMissionButtonActive(viewModel.IsExistArtworkPanelMission);
            });
        }
        ...
        [UIAction]
        void OnArtworkPanelMissionButtonTapped()
        {
            ViewDelegate.OnArtworkPanelMissionButtonTapped();
        }
