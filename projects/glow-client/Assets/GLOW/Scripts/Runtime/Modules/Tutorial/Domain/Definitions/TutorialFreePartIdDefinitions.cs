...
namespace GLOW.Modules.Tutorial.Domain.Definitions
{
    public class TutorialFreePartIdDefinitions
    {
        ...
        public static TutorialFunctionName ReleaseHomeCreate { get; } = new("ReleaseHomeCreate"); // ホームクリエイト開放
        public static TutorialFunctionName TransitHomeCreate { get; } = new("TransitHomeCreate"); // ホームクリエイトの初遷移時
        public static TutorialFunctionName ReleaseArtworkEffect { get; } = new("ReleaseArtworkEffect"); // 原画強化開放
        public static TutorialFunctionName TransitArtworkEffect { get; } = new("TransitArtworkEffect"); // 原画強化の初遷移時
    }
}
