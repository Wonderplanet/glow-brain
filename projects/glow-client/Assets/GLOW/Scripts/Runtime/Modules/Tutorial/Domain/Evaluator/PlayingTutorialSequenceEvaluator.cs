...
namespace GLOW.Modules.Tutorial.Domain.Evaluator
{
    public static class PlayingTutorialSequenceEvaluator
    {
        public static PlayingTutorialSequenceFlag IsPlayingTutorial(
            ...
            IReleaseHardTutorialPlayingStatus releaseHardTutorialPlayingStatus)
        {
            // メインパート中の場合
            ...
            // ハード開放チュートリアル中の場合
            if (releaseHardTutorialPlayingStatus.IsPlayingTutorialSequence)
            {
                return releaseHardTutorialPlayingStatus.IsPlayingTutorialSequence;
            }
