        ...
        UnlimitedCalculableDateTimeOffset EndAt) : ILimitedAmountValueObject
    {
        ...
        public bool IsEnhanceItemType()
        {
            return Type is ItemType.RankUpMaterial or ItemType.RankUpMemoryFragment
                or ItemType.ArtworkGradeUpMaterial or ItemType.ArtworkGradeUpSeriesMaterial;
        }

        public bool IsArtworkGradeUpMaterialType()
        {
            return Type == ItemType.ArtworkGradeUpMaterial;
        }

        public bool IsArtworkGradeUpSeriesMaterialType()
        {
            return Type == ItemType.ArtworkGradeUpSeriesMaterial;
        }

        public bool IsRankUpMaterialType()
        {
            return Type == ItemType.RankUpMaterial;
        }

        public bool IsRankUpMemoryFragmentType()
        {
            return Type == ItemType.RankUpMemoryFragment;
        }
        ...
        public bool IsGachaTicketType()
        {
            return Type == ItemType.GachaTicket;
        }
