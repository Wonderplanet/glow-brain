...
namespace GLOW.Core.Domain.Extensions
{
    public static class StateEffectTypeExtension
    {
        ...
        public static bool IsBuff(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.AttackPowerUp or
                ...
                StateEffectType.RushAttackPowerUp or
                ...
                StateEffectType.WeakeningBlock => true,

                _ => false,
            };
        }

        public static bool IsDebuff(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.AttackPowerDown or
