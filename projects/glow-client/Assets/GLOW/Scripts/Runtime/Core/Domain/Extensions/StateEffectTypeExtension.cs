...
namespace GLOW.Core.Domain.Extensions
{
    public static class StateEffectTypeExtension
    {
        ...
        public static bool IsOverwritable(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.Unbeatable => true,
                _ => false,
            };
        }
        ...
        public static bool IsImmediateEffect(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.SpecialAttackCoolTimeShorten or
                    ...
                    StateEffectType.SummonCoolTimeExtend or
                    StateEffectType.RemoveBuff or
                    StateEffectType.RemoveDebuff => true,
        ...
        #region 効果処理側で使用想定の部分
        public static bool IsRemovableBuff(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.AttackPowerUp or
                ...
                StateEffectType.DamageCutInNormalKoma or
                StateEffectType.RegenerationByFixed or
                StateEffectType.RegenerationByMaxHpPercentage or
                StateEffectType.AttackPowerUpByHpPercentage or
                StateEffectType.DamageCutByHpPercentage or
                // StateEffectType.RushAttackPowerUp or キャラ付与しない特殊StateEffectのため除外
                StateEffectType.Guts or
                StateEffectType.PoisonDamageCut or
                StateEffectType.BurnDamageCut or
                StateEffectType.AttackPowerUpKomaBoost or
                StateEffectType.SlipDamageKomaBlock or
                StateEffectType.AttackPowerDownKomaBlock or
                StateEffectType.GustKomaBlock or
                StateEffectType.PoisonBlock or
                StateEffectType.BurnBlock or
                StateEffectType.KnockBackBlock or
                StateEffectType.StunBlock or
                StateEffectType.FreezeBlock or
                StateEffectType.ForcedKnockBackBlock or
                StateEffectType.WeakeningBlock or 
                StateEffectType.Unbeatable => true,
        ...
        public static bool IsRemovableDebuff(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.AttackPowerDown or
                ...
                StateEffectType.Poison or
                StateEffectType.Burn or
                StateEffectType.Weakening or
                StateEffectType.Stun or
                StateEffectType.Freeze or
                StateEffectType.SlipDamage => true,

                _ => false,
            };
        }
        
        public static bool IsBlockableByUnbeatable(this StateEffectType stateEffectType)
        {
            return stateEffectType switch
            {
                StateEffectType.AttackPowerDown or
                ...
                StateEffectType.Stun or
                StateEffectType.Freeze or
                StateEffectType.SlipDamage or
                StateEffectType.Fierce or
                StateEffectType.SpecialAttackSeal => true,
