    ...
    public sealed class ServerErrorExceptionMapper : IServerErrorExceptionMapper
    {
        public System.Exception Map(ServerErrorException exception)
        {
            ...
            return exception.ServerErrorCode switch
            {
                ...
                (int)ServerErrorCode.PartyDuplicateArtworkId => new PartyDuplicateArtworkIdException(exception),
                (int)ServerErrorCode.PartyInvalidArtworkId => new PartyInvalidArtworkIdException(exception),
                (int)ServerErrorCode.PartyOverArtworkCost => new PartyOverArtworkCostException(exception),
                (int)ServerErrorCode.PartyOverArtworkCount => new PartyOverArtworkCountException(exception),
