...
namespace GLOW.Core.Domain.Models
{
    public record BadgeModel(
        ...
        IReadOnlyList<MissionArtworkPanelRewardCountModel> UnreceivedMissionArtworkPanelRewardCounts,
        ...
        UnopenedMessageCount UnopenedMessageCount)
    {
        public static BadgeModel Empty { get; } = new BadgeModel(
            ...
            new List<MissionArtworkPanelRewardCountModel>(),
            UnreceivedMissionRewardCount.Empty,
        ...
        public UnreceivedMissionRewardCount UnreceivedMissionArtworkPanelRewardCountById(MasterDataId mstArtworkPanelId)
        {
            // 指定なしの場合は空を返す
            if (mstArtworkPanelId.IsEmpty()) return UnreceivedMissionRewardCount.Empty;

            return UnreceivedMissionArtworkPanelRewardCounts
                .FirstOrDefault(model => model.MstArtworkPanelMissionId == mstArtworkPanelId, 
                    MissionArtworkPanelRewardCountModel.Empty)
                .UnreceivedMissionArtworkPanelRewardCount;
        }
