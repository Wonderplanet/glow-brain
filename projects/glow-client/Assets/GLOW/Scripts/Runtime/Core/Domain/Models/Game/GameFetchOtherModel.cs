...
namespace GLOW.Core.Domain.Models
{
    public record GameFetchOtherModel(
        ...
        UserArtworkPartyModel UserArtworkPartyModel,
        ...
        IReadOnlyList<MasterDataId> WebstorePurchaseProductSubIds)
    {
        ...
        public virtual bool Equals(GameFetchOtherModel other)
        {
            ...
            if ((UserArtworkPartyModel == null) ^ (other.UserArtworkPartyModel == null)) return false;
            if (UserArtworkPartyModel != null && other.UserArtworkPartyModel != null)
            {
                if (!UserArtworkPartyModel.Equals(other.UserArtworkPartyModel)) return false;
            }
            ...
            if ((WebstorePurchaseProductSubIds == null) ^ (other.WebstorePurchaseProductSubIds == null)) return false;
            if (WebstorePurchaseProductSubIds != null && other.WebstorePurchaseProductSubIds != null)
            {
                if (!WebstorePurchaseProductSubIds.SequenceEqual(other.WebstorePurchaseProductSubIds)) return false;
            }
        ...
        public override int GetHashCode()
        {
            ...
            hash.Add(UserArtworkPartyModel);
            ...
            AddHashCodes(hash, WebstorePurchaseProductSubIds);
