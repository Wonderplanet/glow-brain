...
namespace GLOW.Core.Domain.ValueObjects
{
    public record MstConfigKey(ObscuredString Value)
    {
        ...
        public static MstConfigKey ArtworkGradeCap => new MstConfigKey("ARTWORK_GRADE_CAP");
        public static MstConfigKey DefaultSeriesLogoId => new MstConfigKey("DEFAULT_SERIES_LOGO_ID");
    }
}
