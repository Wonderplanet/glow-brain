...
{
    public class PlayerResourceIconList : UIObject, IUICollectionViewDataSource, IUICollectionViewDelegate
    {
        [SerializeField] UICollectionView _collectionView;
        [SerializeField] int _shouldScrollItemCount=15;

        IReadOnlyList<PlayerResourceIconViewModel> _iconViewModels = new List<PlayerResourceIconViewModel>();
