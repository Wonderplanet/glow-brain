...
namespace GLOW.Core.Presentation.Components
{
    ...
    public class UILightBlurTextureComponent : UIObject
    {
        ...
        [Header("ぼかした結果の上に色を上書きするか？")]
        [SerializeField] bool _canOverwriteColor = false;
        [Header("上書き後の色")]
        [SerializeField] Color _overwriteColor;
        ...
        void ExecuteBlur()
        {
            ...
            _blurMaterial.SetInt("_CanOverwriteColor", _canOverwriteColor ? 1 : 0);
            _blurMaterial.SetColor("_OverwriteColor", _overwriteColor);
