...
namespace GLOW.Core.Presentation.Views.InAppAdvertisingConfirmView
{
    public class InAppAdvertisingConfirmView : UIView
    {
        ...
        [SerializeField] GameObject _staminaRedTextObject;
        [SerializeField] GameObject _staminaTextObject;
        ...
        public void SetUpStaminaText(int staminaBefore, int staminaAfter)
        {
            _staminaTextObject.SetActive(true);
            _staminaRedTextObject.SetActive(true);

            _staminaBeforeText.SetText(staminaBefore.ToString());
            _staminaAfterText.SetText(staminaAfter.ToString());
        }
