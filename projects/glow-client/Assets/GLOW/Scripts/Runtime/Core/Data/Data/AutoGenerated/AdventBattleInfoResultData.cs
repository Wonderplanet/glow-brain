...
{
    [Serializable]
    public class AdventBattleInfoResultData
    {
        [DataMember(Name = "adventBattleResult")][JsonProperty("adventBattleResult")]
        public AdventBattleResultData AdventBattleResult { get; set; }
