...
namespace GLOW.Core.Data.DataStores
{
    public sealed class StageApi
    {
        ...
        public async UniTask<StageStartResultData> Start(CancellationToken cancellationToken, string mstStageId, int partyNo, bool isChallengeAd, int? lapCount, int randomSeed)
        {
