    ...
    internal sealed class OprDataToCacheDataConverter : IMstDataToCacheDataConverter
    {
        ...
        IEnumerable<MstCacheData> IMstDataToCacheDataConverter.Convert(Language language)
        {
            return new[]
            {
                ...
                new MstCacheData(MasterType.Opr, typeof(OprStepupGachaData), _data.OprStepupGacha),
                new MstCacheData(MasterType.Opr, typeof(OprStepupGachaStepData), _data.OprStepupGachaStep),
                new MstCacheData(MasterType.Opr, typeof(OprStepupGachaStepRewardData), _data.OprStepupGachaStepReward),
