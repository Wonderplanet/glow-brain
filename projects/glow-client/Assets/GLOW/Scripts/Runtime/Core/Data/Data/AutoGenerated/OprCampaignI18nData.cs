...
{
    [Serializable]
    public class OprCampaignI18nData
    {
        ...
        [DataMember(Name = "oprCampaignId")][JsonProperty("oprCampaignId")]
        public string OprCampaignId 
        {
            get => _obscured_oprCampaignId;
            set => _obscured_oprCampaignId = value ?? string.Empty;
        }
        ...
        ObscuredString _obscured_oprCampaignId;
