...
namespace GLOW.Core.Data.Services
{
    public sealed class GameService : IGameService
    {
        ...
        async UniTask<GameUpdateAndFetchResultModel> IGameService.UpdateAndFetch(
            CancellationToken cancellationToken,
            string countryCode)
        {
            try
            {
                var updateAndFetchResultData = await GameApi.UpdateAndFetch(cancellationToken, countryCode);
