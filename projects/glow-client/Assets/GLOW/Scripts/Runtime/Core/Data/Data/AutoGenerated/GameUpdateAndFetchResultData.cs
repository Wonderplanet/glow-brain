...
{
    [Serializable]
    public class GameUpdateAndFetchResultData
    {
        [DataMember(Name = "fetch")][JsonProperty("fetch")]
        public GameFetchData Fetch { get; set; }
        [DataMember(Name = "fetchOther")][JsonProperty("fetchOther")]
        public GameFetchOtherData FetchOther { get; set; }
