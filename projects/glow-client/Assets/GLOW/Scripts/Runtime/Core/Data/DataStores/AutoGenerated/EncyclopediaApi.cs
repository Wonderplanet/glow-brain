...
namespace GLOW.Core.Data.DataStores
{
    public sealed class EncyclopediaApi
    {
        ...
        public async UniTask<ArtworkGradeUpResultData> ArtworkGradeUp(CancellationToken cancellationToken, string mstArtworkId)
        {
            var param = new JsonParamArtworkGradeUp();
            ...
            return await APIContext.Post<ArtworkGradeUpResultData>(cancellationToken, "/api/encyclopedia/artwork/grade_up", payload);
        }
    }
}