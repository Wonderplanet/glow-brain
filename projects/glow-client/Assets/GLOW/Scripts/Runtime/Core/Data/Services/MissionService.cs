...
namespace GLOW.Core.Data.Services
{
    public class MissionService : IMissionService
    {
        ...
        async UniTask<MissionArtworkPanelUpdateAndFetchResultModel> IMissionService.ArtworkPanelUpdateAndFetch(CancellationToken cancellationToken)
        {
            try
            {
                var missionArtworkPanelFetchData = await MissionApi.ArtworkPanelUpdateAndFetch(cancellationToken);
                return MissionArtworkPanelUpdateAndFetchResultDataTranslator.ToMissionArtworkPanelUpdateAndFetchResultModel(
                    missionArtworkPanelFetchData);
            }
            catch (ServerErrorException se)
            {
                throw ServerErrorExceptionMapper.Map(se);
