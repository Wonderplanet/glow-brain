...
namespace GLOW.Core.Data.Translators.Pvp
{
    public class PvpDataTranslator
    {
        ...
        public static PvpEndResultModel ToPvpEndResultModel(PvpEndResultData data)
        {
            ...
            var userParameters = data.UsrParameter == null
        ...
        static OpponentPvpStatusModel ToOpponentPvpStatusModel(OpponentPvpStatusData data)
        {
            ...
            var artworkPartyStatuses = data.ArtworkPartyStatuses == null
                ? new List<ArtworkPartyStatusModel>()
                : data.ArtworkPartyStatuses.Select(ToArtworkPartyStatusModel).ToList();
        ...
        static ArtworkPartyStatusModel ToArtworkPartyStatusModel(ArtworkPartyStatusData data)
        {
            if (data == null)
            {
                return ArtworkPartyStatusModel.Empty;
            }

            return new ArtworkPartyStatusModel(
                string.IsNullOrEmpty(data.MstArtworkId) ? MasterDataId.Empty : new MasterDataId(data.MstArtworkId),
