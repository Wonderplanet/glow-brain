...
namespace GLOW.Core.Data.Translators
{
    public class MissionBulkReceiveRewardResultDataTranslator
    {
            ...
            MissionBulkReceiveRewardResultData missionBulkReceiveRewardResultData)
         {
            ...
            var artworkData = missionBulkReceiveRewardResultData.UsrArtworks;
            var artworkModels = artworkData
                .Select(UserArtworkDataTranslator.ToUserArtworkModel)
                .ToList();
            
            var artworkFragmentData = missionBulkReceiveRewardResultData.UsrArtworkFragments;
            var artworkFragmentModels = artworkFragmentData
