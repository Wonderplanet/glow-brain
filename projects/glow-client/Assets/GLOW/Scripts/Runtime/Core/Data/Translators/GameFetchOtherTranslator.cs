...
namespace GLOW.Core.Data.Translators
{
    public static class GameFetchOtherTranslator
    {
        public static GameFetchOtherModel TranslateToModel(GameFetchOtherData gameFetchOtherData)
        {
            ...
            var userArtworkPartyModel = UserArtworkPartyDataTranslator.ToModel(gameFetchOtherData.UsrArtworkParty);
            ...
            var webstorePurchaseProductSubIds = gameFetchOtherData.WebstorePurchaseProductSubIds
