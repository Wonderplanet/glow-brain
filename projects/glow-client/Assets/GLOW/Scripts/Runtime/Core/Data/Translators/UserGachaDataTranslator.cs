    ...
    public class UserGachaDataTranslator
    {
        public static UserGachaModel ToUserGachaModel(UsrGachaData data)
        {
            return new UserGachaModel(
                ...
                data.CurrentStepNumber.HasValue
                    ? new StepUpGachaCurrentStepNumber(data.CurrentStepNumber.Value)
                    : StepUpGachaCurrentStepNumber.Empty,
                data.LoopCount.HasValue
                    ? new StepUpGachaCurrentLoopCount(data.LoopCount.Value)
