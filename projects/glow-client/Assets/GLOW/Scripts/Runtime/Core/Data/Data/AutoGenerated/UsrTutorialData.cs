...
{
    [Serializable]
    public class UsrTutorialData
    {
        [DataMember(Name = "mstTutorialFunctionName")][JsonProperty("mstTutorialFunctionName")]
        public string MstTutorialFunctionName 
        {
            get => _obscured_mstTutorialFunctionName;
            set => _obscured_mstTutorialFunctionName = value ?? string.Empty;
        }


        ObscuredString _obscured_mstTutorialFunctionName;
    }
}
