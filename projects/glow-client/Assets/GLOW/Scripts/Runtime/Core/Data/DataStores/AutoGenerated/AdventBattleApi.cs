...
namespace GLOW.Core.Data.DataStores
{
    public sealed class AdventBattleApi
    {
        ...
        public async UniTask<HeadOK> Start(CancellationToken cancellationToken, string mstAdventBattleId, int partyNo, bool isChallengeAd, int randomSeed, InGameStartBattleLogData inGameBattleLog)
        {
