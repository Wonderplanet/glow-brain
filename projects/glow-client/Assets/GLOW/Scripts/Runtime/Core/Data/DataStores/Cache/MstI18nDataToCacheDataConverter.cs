...
namespace GLOW.Core.Data.DataStores.Cache
{
    internal sealed class MstI18nDataToCacheDataConverter : IMstDataToCacheDataConverter
    {
        ...
        IEnumerable<MstCacheData> IMstDataToCacheDataConverter.Convert(Language language)
        {
            ...
            var mstArtworkEffectI18nData = _data.MstArtworkEffectI18n.Where(mst => mst.Language == language).ToArray();
            var mstHomeKomaPatternI18nData = _data.MstHomeKomaPatternI18n.Where(mst => mst.Language == language).ToArray();
            ...
            return new[]
            {
                ...
                new MstCacheData(MasterType.MstI18n, typeof(MstArtworkEffectI18nData), mstArtworkEffectI18nData),
                new MstCacheData(MasterType.MstI18n, typeof(MstHomeKomaPatternI18nData), mstHomeKomaPatternI18nData),
            };
        }
    }
}
