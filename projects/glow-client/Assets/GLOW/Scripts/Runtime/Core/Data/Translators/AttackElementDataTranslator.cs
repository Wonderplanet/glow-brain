...
namespace GLOW.Core.Data.Translators
{
    public static class AttackElementDataTranslator
    {
            ...
            MstAttackHitEffectData mstAttackHitEffectData)
        {
            ...
            StateEffect effect = StateEffect.Empty;
            if (data.EffectType != StateEffectType.None)
            {
                var effectConditionRole = string.IsNullOrEmpty(data.EffectTriggerRoles)
                    ? StateEffectConditionValue.Empty
                    : new StateEffectConditionValue(data.EffectTriggerRoles);
                var effectConditionColor = string.IsNullOrEmpty(data.EffectTriggerColors)
                    ? StateEffectConditionValue.Empty
                    : new StateEffectConditionValue(data.EffectTriggerColors);
                
                effect = new StateEffect(
                    data.EffectType,
                    ...
                    new StateEffectValue(data.EffectValue),
                    effectConditionRole,
                    effectConditionColor);
            }
