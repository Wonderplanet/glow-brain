...
namespace GLOW.Core.Data.DataStores
{
    public sealed class PvpApi
    {
        ...
        class JsonParamStart
        {
            ...
            [DataMember(Name = "randomSeed")] [SerializeField] [JsonProperty("randomSeed")] int randomSeed;
        ...
        public async UniTask<PvpStartResultData> Start(CancellationToken cancellationToken, string sysPvpSeasonId, int isUseItem, string opponentMyId, int partyNo, int randomSeed, InGameStartBattleLogData inGameBattleLog)
        {
