...
{
    [Serializable]
    public class PurchaseHistoryResultData
    {
        [DataMember(Name = "currencyPurchases")][JsonProperty("currencyPurchases")]
        public CurrencyPurchaseData[] CurrencyPurchases { get; set; }
