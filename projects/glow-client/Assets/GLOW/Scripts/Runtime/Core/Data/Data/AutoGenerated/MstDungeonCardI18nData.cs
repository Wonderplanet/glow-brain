...
{
    [Serializable]
    public class MstDungeonCardI18nData
    {
        ...
        [DataMember(Name = "mstDungeonCardId")][JsonProperty("mstDungeonCardId")]
        public string MstDungeonCardId 
        {
            get => _obscured_mstDungeonCardId;
            set => _obscured_mstDungeonCardId = value ?? string.Empty;
        }
        ...
        ObscuredString _obscured_mstDungeonCardId;
