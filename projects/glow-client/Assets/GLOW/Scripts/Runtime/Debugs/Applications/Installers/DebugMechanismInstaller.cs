...
namespace GLOW.Debugs.Applications.Installers
{
    ...
    public class DebugMechanismInstaller : ScriptableObjectInstaller<DebugMechanismInstaller>
    {
        ...
        [SerializeField] AdminDebugInputView _adminDebugInputView;
        ...
        public override void InstallBindings()
        {
            ...
            Container.BindViewFactoryInfo<
                DebugArtworkEffectDetailViewController,
                DebugArtworkEffectDetailViewInstaller>();
        ...
        void BindAdminDebug()
        {
            ...
            if (_adminDebugInputView != null)
            {
                Container.BindInterfacesTo<AdminDebugInputPresenter>().AsCached();
                Container
                    .Bind<AdminDebugInputView>()
                    .FromComponentInNewPrefab(_adminDebugInputView)
                    .AsTransient();
            }
