...
namespace BuildIntegration.BuildActions.AddSkAdNetworkIdentifier
{
    public class ManuallyAddSKAdNetworkIdentifierPostBuild :IPostprocessBuildWithReport
    {
        public string[] Identifiers = new string[]
        {
            // NOTE: 対象アドネットワーク
            // AppLovin
            // UnityAds
        ...
        void IPostprocessBuildWithReport.OnPostprocessBuild(BuildReport report)
        {
            ...
            SetXcodePlist(report.summary.outputPath);
        }

        void SetXcodePlist(string pathToBuiltProject)
        {
