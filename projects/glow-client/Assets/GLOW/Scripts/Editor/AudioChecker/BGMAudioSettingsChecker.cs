...
{
    public class BGMAudioSettingsChecker : EditorWindow
    {
        enum AudioStatus
        {
            Correct,
        ...
        const string AudioFolder = "Assets/GLOW/Audios/Data/BGM";
        const float ExpectedQuality = 0.25f;
        ...
        [MenuItem("GLOW/Check/BGM Audio Settings/Show Window")]
        static void ShowWindow()
        {
            var window = GetWindow<BGMAudioSettingsChecker>();
            window.titleContent = new GUIContent("BGM Audio Settings Checker");
            window.Show();
        }
        
        [MenuItem("GLOW/Check/BGM Audio Settings/Run Check")]
        public static void CheckBGMAudioSettingsFromMenu()
        {
            ...
            List<string> errors)
        {
            ...
            {
                sb.Append(ZString.Format("Checked {0} wave files in BGM folder.\n\n", checkedCount));
        ...
        void OnGUI()
        {
            EditorGUILayout.LabelField("BGM Audio Settings Checker", EditorStyles.boldLabel);
