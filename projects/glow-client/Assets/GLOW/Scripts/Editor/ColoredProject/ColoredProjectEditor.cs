...
namespace GLOW.Editor.ColoredProject
{
    public class ColoredProjectEditor
    {
        const string MenuPath = "GLOW/ColoredProjectEditor";
        static readonly string[] Keywords = {
            "scenes", "assetbundles", "graphics", "prefabs", "scenes", "scripts", "tests"
        };
        ...
        {
            if (!assetPath.Contains("GLOW")) { return (-1, 0); }
        ...
        static Color GetColorForDarkSkin(int id)
        {
            switch (id % 8)
            {
                ...
                case 4: return new Color(0.2f, 8.4f, 9.6f, 0.50f);
        ...
        static Color GetColorForLightSkin(int id)
        {
            switch (id % 8)
            {
                ...
                case 4: return new Color(0.2f, 1.4f, 1.6f, 0.15f);
